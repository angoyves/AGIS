...
<table width="60%" border="0" align="center">
  ...
  <tr>
    ...
    $totalRows_rsMois2 = mysql_num_rows($rsMois2); ?>
        <tr>
          <td nowrap="nowrap"><a href="todelete.php?recordID=<?php echo $row_rsSessions['membres_personnes_personne_id']; ?>"> <?php echo $row_rsSessions['membres_personnes_personne_id']; ?>&nbsp; </a></td>
          <td nowrap="nowrap"><?php echo $row_rsSessions['personne_nom'] . " " . $row_rsSessions['personne_prenom']; ?>&nbsp; </td>
          <td align="right" nowrap="nowrap"><?php echo $row_rsSessions['fonction_lib']; ?>&nbsp; </td>
          <td nowrap="nowrap"><?php if ($row_rsSessions['banque_code'] == 'XXXXX'){ echo 'Absent'; } else { echo strtoupper($row_rsSessions['banque_code'] . "-" . $row_rsSessions['agence_code'] . "-" . $row_rsSessions['numero_compte'] . "-" . $row_rsSessions['cle']);} ?>
            &nbsp; </td>
		...
		?>
          <td align="right" nowrap="nowrap"><?php echo number_format($row_rsTotal['Total'],0,' ',' '); ?>&nbsp;<strong>
	  ...
	  ?>
          ...
          <?php } while ($row_rsMois3 = mysql_fetch_assoc($rsMois3)); ?>
...
$totalRows_rsMois6 = mysql_num_rows($rsMois6);
	?>
        <tr>
          <td align="left" nowrap="nowrap"><a href="todele.php?recordID=<?php echo $row_rsSousCommission['membres_personnes_personne_id']; ?>"> <?php echo $row_rsSousCommission['membres_personnes_personne_id']; ?>&nbsp; </a></td>
          <td align="left" nowrap="nowrap"><?php echo strtoupper($row_rsSousCommission['personne_nom']) . " " . ucfirst($row_rsSousCommission['personne_prenom']); ?>&nbsp; </td>
          <td align="right" nowrap="nowrap"><?php echo $row_rsSousCommission['fonction_lib']; ?>&nbsp; </td>
          <td nowrap="nowrap"><?php if ($row_rsSousCommission['banque_code'] == 'XXXXX'){ echo 'Absent'; } else { echo strtoupper($row_rsSousCommission['banque_code'] . "-" . $row_rsSousCommission['agence_code'] . "-" . $row_rsSousCommission['numero_compte'] . "-" . $row_rsSousCommission['cle']);} ?>
            &nbsp; </td>
		...
		?>
          <td align="right"><?php echo number_format($row_rsTotal2['Total'],0,' ',' '); ?>&nbsp;<strong>
	  ...
	  ?>
          ...
          <td nowrap="nowrap">&nbsp;</td>
          <td nowrap="nowrap"><?php echo number_format($Totaux,0,' ',' '); ?></td>
        </tr>
      </table>
      <br />
