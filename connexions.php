...
if (isset($_POST['user'])) {
  ...
  $MM_redirectQuestionIsNull = "update_user.php";
  $MM_redirecttoReferrer = true;
  mysql_select_db($database_MyFileConnect, $MyFileConnect);
  	
  $LoginRS__query=sprintf("SELECT * FROM users WHERE user_login=%s AND user_password=%s AND display=%s",
...
<div id="container">
  ...
  <ul>
    <table border="0" align="center">
      <tr>
        <td width="213" align="left" scope="col"><a href="http://172.18.0.96:8080/"><img src="images/img/logo_minmap.gif" alt="Connexion à AGIS" width="200" height="223" class="ps-staticimg" title="Connexion à AGIS" /></a>
        </td>
