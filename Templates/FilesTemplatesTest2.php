...
<head>
<title>AGIS MINMAP : Accueil</title>
  ...
  <div id="inner">
    ...
    <div id="header">
      <div id="logo"><img src="../images/amoirie.gif" alt="armoirie" width="78" height="52"><a href="#" target="_top"><img src="images/logo_minefi.gif" alt="Ministère des Finances et du Budget" width="89" border="0" height="52" hspace="2"></a>
        <!--        <h2>Le portail du Minist&egrave;re de l'&Eacute;conomie, des Finances et  de l'industrie</h2>
 -->
      </div>
      <!-- /#logo -->
      <div class="menu">
    ...
    <div class="col_droite">
      <div class="bloc express">   <h4>Actualit&eacute;</h4>
<p>{cms_module module=nfs detailpage='53' moretext="lire plus" }</p>

<p>&nbsp;</p>
<a href="#" class="rss">Flux RSS</a><div class="clear-both"></div>   </div>
      <div class="bloc lois_recentes">
        <h4>Menu</h4>
        <ul class="tous_les">
          {menu template='minimal_menu.tpl' collapse='1'}
        </ul>
      </div>
      ...
      <div class="logos">
        <div class="bloc express">
          <h4><strong>A votre avis</strong></h4>
          <p>{cms_module module='polls'}</p>
          <p>&nbsp;</p>
        </div>
        <div class="bloc express">
          <h4><strong>Visiteurs</strong></h4>
          <p><strong>{Statistics what="total" how="txt"}</strong></p>
          <p>&nbsp;</p>
        </div>
        <p><img src="images/marianne.gif" alt="Cameroun"></p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
    ...
    <!--/.col_droite-->
    <div class="contenu"> <a name="work_h"></a>
      <!--/.bio-->
      <div class="col_d webtvgouv">

        <!--div class="bloc web_tv">
					<h3>Web TV</h3>
					<a href="http://www.dailymotion.com/economie" target="_blank"><img src="img/actu/video_web_tv.jpg" alt="Web TV Bercy" border="0"></a>
					<dl>
						<dt>Derni&egrave;re video</dt>
						<dd>Titre de la vid&eacute;o <span>(1mn 47s)</span></dd>
					</dl>
					<p class="right"><a href="#" class="tous_les">Toutes les vid&eacute;os</a></p>
		</div-->
        <!--/.bloc web_tv--><!--/.bloc-->
        <!--/.bloc-->
        <div class="bloc">
          ...
          <div class="b_actions">
            <h4>Calendrier</h4>
            <dl>
              <dt><!-- TemplateBeginEditable name="BoxEdit1" -->BoxEdit1<!-- TemplateEndEditable --></dt>
            </dl>
          </div>
          <div class="b_actions">
            <h4>Agenda</h4>
            <dl>
              <dt><span class="bloc lois_recentes">{cms_module module='Calendar' table_id='big' lang="fr_FR" display="calendar"}</span></dt>
            </dl>
          </div>
          <div class="b_actions">
            <h4>Reunions</h4>
            <dl>
              <dt>Reunion du 23/03/2010 &agrave; 17h00 :</dt>
              <dd><strong>R&eacute;union de la cellule de coordination &agrave; la permanence du Programme sous la pr&eacute;sidence du Coordonnateur national ...</strong></dd>
            </dl>
          </div>
          <!--/.b_actions-->
        </div>
        <!--/.bloc-->
        <div class="bloc espaces">
          <h3>Liens utiles</h3>
          <a href="www.douanes.cm"><img src="img/v2/espace_douane.jpg" alt="Direction Générale des Douanes"></a> 
        <a href="http://www.impots.cm" target="_blank"><img src="img/v2/espace_impots.jpg" alt="Direction Générale des Impots"></a></div>
        <!--/.bloc espaces-->
	  ...
	  <span class="toutes_les_actus"><a href="#">Tout sur la Cellule de Reflexion GAR MINFI</a></span>

        <h3>Objectif</h3>
		
		
		<p class="type"><em> </em></p>
		<div class="b_actions">
		  <h4>Agenda</h4>
		  <dl>
		    <dt><span class="bloc lois_recentes">{cms_module module='Calendar' table_id='big' lang="fr_FR" display="calendar"}</span></dt>
		...
		<p class="type"><em>22 novembre  2010</em></p>

        <h4>Contexte du programme</h4>
      
        <p> L&rsquo;inefficacit&eacute;  de l&rsquo;Administration publique camerounaise est constamment remise sur la  sellette, en d&eacute;pit des r&eacute;formes qui ont &eacute;t&eacute; jusque l&agrave; entreprises en vue de sa  modernisation. R&eacute;cemment encore, le Pr&eacute;sident...<a href="index.php?page=contexte" class="tous_les">Lire</a>        
        <p>&nbsp; </p>       
        <p class="type"><em>22 novembre  2010</em></p>
        <h4>la problématique de la gestion du rendement dans l'administration publique Camerounaise : Cadre réglémentaire</h4>
        <p> Il n&rsquo;existe pas une multitude de documents de  r&eacute;f&eacute;rence sur la gestion du rendement dans l&rsquo;Administration camerounaise. Le  principal document de ce genre est la <em>Circulaire N</em><em>&deg; 004/CAB/PM du 06  septembre 1993</em> <em>relative </em>...<a href="index.php?page=problematique" class="tous_les">Lire</a>
        <p>&nbsp; </p>        
        <p class="type"><em>22 novembre  2010</em></p>
        <h4>Description du programme</h4>
            L’objectif du programme est de contribuer à l’amélioration des performances de l’administration publique...
        <p>Le programme est structur&eacute; en deux grands volets&nbsp;: Dimensions  transversales et dimensions sp&eacute;cifiques &agrave; chaque administration pilote.<a href="index.php?page=description" class="tous_les">Lire</a></p>
</ul>
<p>&nbsp; </p>
<p class="type"><em>22 novembre  2010</em></p>
        <h4>Tableau synoptique des r&eacute;sultats</h4>
        <p> Consultez le tableau synoptique de r&eacute;sultat...<a href="index.php?page=tableau" class="tous_les">Lire </a>
        <p>&nbsp; </p>
        <p class="type"><em>22 novembre  2010</em></p>
        <h4>Mise en oeuvre du programme</h4>

          Le programme est dirigé par un Comité de Pilotage institué par le Premier Ministre, Chef du Gouvernement (Arrêté No 112 CAB/PM du 06 juin 2007 portant création, organisation et fonctionnement du Comité de Pilotage du Projet de modernisation de l’Administration camerounaise par la mise en œuvre de la gestion axée sur les résultats)...<a href="index.php?page=programme" class="tous_les">Lire </a>
          <p>        
      </div>
      <!--<div class="bulle2 com_presse2">
        ...
        <h4>Présentation du projet de loi de finances pour 2011</h4>
                  ...
                  <p>        <a href="/actus/10/100929presentation-plf2011.html"><img src="/img/min/100929plf6.jpg" alt="essimi menye" width="180" height="120" border="0" / title="essimi menye"></a> essimi menye et François BAROIN,  ministre du Budget, des Comptes Publics et de la
