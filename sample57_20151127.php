...
<table>
  <tr>
    ...
    <!--<form action="scriptValidate.php" method="post">-->
		...
		$link1 = 'scriptControlate1.php?comID='.$_GET['comID'].'&mID='.$_POST['txt_Month'].'&aID='.$_POST['txt_Year'];
		$link2 = 'scriptControlate2.php?comID='.$_GET['comID'].'&mID='.$_POST['txt_Month'].'&aID='.$_POST['txt_Year'];?>
        <input name="BtnValider" type="button" value="Demander modification" onclick="<?php popup($link1, "700", "400"); ?>">
        <input name="BtnValider" type="button" value="Valider la Saisie de l'etat de la  commission" onclick="<?php popup($link2, "700", "400"); ?>">
        <?php } ?>
    <!--</form>--></td>
  </tr>
</table>
