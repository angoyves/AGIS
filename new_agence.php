...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO agences (agence_id, agence_code, agence_lib, banque_code, agence_cle, date_creation, dateUpdate, display) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "afficher_agences.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<p>&nbsp;</p><div class="clear-both"></div>   </div>
    ...
    <h1>Inserer une Angence...</h1>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Code agence :</td>
      <td><input name="agence_code" type="text" value="" size="15" maxlength="5" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Nom Agence :</td>
      <td><input type="text" name="agence_lib" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Code Banque :</td>
      <td><select name="banque_code">
        <option value=""  <?php if (!(strcmp("", $row_rsBanques['banque_code']))) {echo "selected=\"selected\"";} ?>>[ Select... ]</option>
        <?php
do {  
?>
        <option value="<?php echo $row_rsBanques['banque_code']?>"<?php if (!(strcmp($_POST['banque_code'], $row_rsBanques['banque_code']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsBanques['banque_lib']?></option>
        <?php
