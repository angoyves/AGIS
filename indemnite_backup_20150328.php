...
$query_rsSousGroupe = "SELECT sous_groupe_id, sous_groupe_lib , sous_groupes.pourcentage as taux, groupe_lib, groupes.pourcentage  FROM sous_groupes, groupes WHERE sous_groupes.groupe_id = groupes.groupe_id AND sous_groupes.groupe_id = 1";
$rsSousGroupe = mysql_query($query_rsSousGroupe, $MyFileConnect) or die(mysql_error());
$row_rsSousGroupe = mysql_fetch_assoc($rsSousGroupe);
$totalRows_rsSousGroupe = mysql_num_rows($rsSousGroupe);
}
