  ...
  <tr>
    ...
    <td><form name="form" id="form">
      <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
        ...
        <option value="<?php echo "show_commissions.php?typID=2&menuID=" . $_GET['menuID'] . "&action=" . $_GET['action'] ?>">Commission ministérielle</option>
        <option value="<?php echo "show_commissions.php?typID=3&menuID=" . $_GET['menuID'] . "&action=" . $_GET['action'] ?>">Commission régionale</option>
        <option value="<?php echo "show_commissions.php?typID=4&menuID=" . $_GET['menuID'] . "&action=" . $_GET['action'] ?>">Commission départementale</option>
        <option value="<?php echo "show_commissions.php?typID=5&menuID=" . $_GET['menuID'] . "&action=" . $_GET['action'] ?>">Commission communale</option>
      </select>
      <img src="img/b_search.png" width="16" height="16" />
    </form></td>
  </tr>
  <tr>
    <td scope="row">&nbsp;</td>
...
<?php } ?>
  ...
  <?php $counter=0; do  { $counter++; ?>
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      <td nowrap="nowrap" ><a href="show_commissions.php?menuID=<?php echo $_GET['menuID'];?>&amp;action=<?php echo $_GET['action'];?>&amp;comID=<?php echo $row_rsCommissions['commission_id']; ?>&amp;typID=<?php echo $_GET['typID']; ?>"> <img src="img/b_views.png" width="16" height="16" /></a></td>
...
$totalRows_rsTypeCommission = mysql_num_rows($rsTypeCommission);
      ...
      <td align="center" nowrap="nowrap">
       ...
       <!-- <a href="sample16.php?&amp;comID=<?php //echo $row_rsCommissions['commission_id']; ?>&amp;menuID=<?php //echo $_GET['menuID']; ?>&amp;valid=mb"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/><span class="succes">Ajouter une session</span></a>--><span class="succes"><a href="add_membre.php?comID=<?php echo $row_rsCommissions['commission_id']; ?>&amp;menuID=<?php echo $_GET['menuID']; ?>&amp;valid=mo">Commission OK<img src="img/b_edit.png" alt="" width="16" height="16" align="absmiddle"/></a></span>
        <?php } else { ?>
        <a href="new_membres.php?menuID=<?php echo $_GET['menuID']; ?>&amp;comID=<?php echo $row_rsCommissions['commission_id']; ?>&amp;action=new" class="control"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter des membres</a>
      <?php } ?>
      <?php } else { ?>
			<?php if (isset($row_rsCommissionLib['membre_insert']) && $row_rsCommissionLib['membre_insert'] == '1') { ?>
                      <a href="valid_sessions.php?&amp;comID=<?php echo $row_rsCommissionLib['commission_id']; ?>&amp;menuID=<?php echo $_GET['menuID']; ?>&amp;valid=mb" class="succes"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter une session</a>
            <?php } else { ?>
                      <a href="new_membres2.php?menuID=<?php echo $_GET['menuID']; ?>&amp;comID=<?php echo $row_rsCommissionLib['commission_id']; ?>&amp;action=new" class="control"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter les membres</a>
			<?php } ?>
      <?php } ?>
</td>
      <td align="center" nowrap="nowrap">
      ...
      <a href="sous_commission_db.php?menuID=<?php echo $_GET['menuID']; ?>&comID=<?php echo $row_rsCommissions['commission_id']; ?>&action=new&typID=<?php echo $_GET['typID']; ?>" class="succes" onClick="return confirm('Etes vous sur de vouloir créer une nouvelle Sous-commission ?');"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter une sous commission</a>
      <?php echo "(" . $countID = MinmapDB::getInstance()->get_count_sous_commission_by_commission_id($row_rsCommissions['commission_id']) . ")" ?>
      <?php } else { ?>
      <a href="sous_commission_db.php?menuID=<?php echo $_GET['menuID']; ?>&comID=<?php echo $row_rsCommissions['commission_id']; ?>&action=new&typID=<?php echo $_GET['typID']; ?>" class="control" onClick="return confirm('Etes vous sur de vouloir créer une nouvelle Sous-commission ?');"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter une sous commission</a>
      <?php echo "(" . $countID = MinmapDB::getInstance()->get_count_sous_commission_by_commission_id($row_rsCommissions['commission_id']) . " )" ?>
      <?php } ?>
      <?php } ?>
      </td>
...
<table>
  ...
  <table width="50%" border="1" align="center" class="std">
    ...
    <?php $counter=0; do  { $counter++; ?>
      <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
        <td nowrap="nowrap"><a href="show_commissions.php?comID=<?php echo $row_rsCommissions['commission_id']; ?>"><img src="img/b_views.png" alt="" width="16" height="16" /></a></td>
  ...
  <table width="50%" border="1" align="center" class="std">
    ...
    <?php $counter=0; do  { $counter++; ?>
      <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
		...
		<?php if (isset($row_RsNombresSession['Nombre']) && $row_RsNombresSession['Nombre'] > 0) { ?>
                <a href="valid_representant.php?&amp;comID=<?php echo $_GET['comID']; ?>&amp;menuID=<?php echo $_GET['menuID']; ?>&amp;valid=mo"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/><span class="succes">Ajouter une session</span></a>
                <?php } else { ?>
                <a href="new_membres.php?menuID=<?php echo $_GET['menuID']; ?>&amp;comID=<?php echo $row_rsCommissions['commission_id']; ?>&amp;action=new" class="control"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter des membres</a>
              <?php } ?>
        &nbsp;</td>
...
<?php if ($totalRows_rsCommissionLib > 0) { // Show if recordset not empty ?>
  <?php if (isset($_GET['comID'])) {?>
  <h1>Sous Commission Dépendante de la <?php echo $commissionName; ?></h1>
<table>
  <tr>
    <td><?php $link = "etat_financier_recap.php?menuID=" .  $_GET['menuID']. "&action=" . $_GET['action'] . "&menuID=" . $_GET['menuID'] ?>
      <?php $link6 = "new_representant.php?aID=" . $_POST['txt_Year']. "&mID=" . $_POST['txt_Month'] . "&comID=" . $_GET['comID'] . "&menuID=" . $_GET['menuID'] ?>
  ...
  <table width="50%" border="1" align="center" class="std">
    ...
    <?php $counter=0; do  { $counter++;?>
      <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
        <td nowrap="nowrap"><a href="show_commissions.php?scomID=<?php echo $row_rsCommissionLib['commission_id']; ?>&comID=<?php echo $row_rsCommissionLib['commission_id']; ?>"><img src="img/b_views.png" alt="" width="16" height="16" /></a></td>
...
<?php } else { ?>
          ...
          <?php } ?>
          &nbsp;</td>
        <td nowrap="nowrap"><a href="del_commissions.php?menuID=<?php echo $_GET['menuID'];?>&amp;&amp;action=<?php echo $_GET['action'];?>&amp;comID=<?php echo $_GET['comID']; ?>&amp;scomID=<?php echo $row_rsCommissionLib['commission_id']; ?>" onClick="return confirm('Etes vous sur de vouloir supprimer cette Sous-commission ?');"><img src="img/b_drop.png" alt="" width="16" height="16" align="absmiddle"/></a>&nbsp;</td>
        <td nowrap="nowrap"><a href="maj_commissions.php?menuID=<?php echo $_GET['menuID'];?>&amp;&amp;action=<?php echo $_GET['action'];?>&amp;&amp;comID=<?php echo $row_rsCommissionLib['commission_id']; ?>"><img src="img/b_edit.png" alt="" width="16" height="16" align="absmiddle"/></a>&nbsp;</td>
        </tr>
