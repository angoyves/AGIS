...
$colname_rsSessions4 = "-1";
if (isset($_GET['persID'])) {
  $colname_rsSessions4	 = $_GET['persID'];
}
mysql_select_db($database_MyFileConnect, $MyFileConnect);
...
AND mois = %s 
AND annee = %s 
ORDER BY fonctions.fonction_id", GetSQLValueString($colname_rsSessions, "int"),GetSQLValueString($colname_rsSessions4, "int"),GetSQLValueString($colname_rsSessions1, "text"),GetSQLValueString($colname_rsSessions2, "text"));
