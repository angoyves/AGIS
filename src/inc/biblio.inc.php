...
function openRequestedPopup() {
  windowObjectReference = window.open('$url', '', 'directories=no, toolbar=no, scrollbars=1, resizable=1, width=$width, height= $height');
}
}*/

function close_popup(){
		print "window.opener.location.reload(); self.close();";
  }
