...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO appurement (sessions_commission_id, sessions_personne_id, sessions_fonction_id, sessions_jour, taux, Nombre_session, sessions_mois, sessions_annee, montant, dateCreation, dateUpdate, display) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['Nombre_session'], "int"),
