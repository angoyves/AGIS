...
<?php
	  ...
	  require('includes/MyFonction.php');
		...
		if (isset($_REQUEST['mID'])) {
		  $txtMonth = $_REQUEST['mID'];
		}
		$txtYear = "-1";
		if (isset($_REQUEST['aID'])) {
		  $txtYear = $_REQUEST['aID'];
		}
?>
<?php

//echo $comID.'  '. $txtMonth.'   '. $_POST['txt_Year'];

$etat_validate = (MinmapDB::getInstance()->afficher_etat_valide($comID, $txtMonth, $txtYear));
$etat_controlate = (MinmapDB::getInstance()->afficher_etat_control($comID, $txtMonth, $txtYear));
...
$link = "print_sessions.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID. "&menuID=" . $_GET['menuID']."&tab=4";
$link11 = "sample42.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID. "&menuID=" . $_GET['menuID'];
$link12 = "etat_financier_recap_pers.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID . "&menuID=" . $_GET['menuID'];
$link2 = "sample26.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID  . "&menuID=" . $_GET['menuID'] . "&lID=" . $_GET['lID'];
$link3 = "sample26.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&menuID=" . $_GET['menuID']. "&lID=" . $_GET['lID'];
$link4 = "sample26.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID . "&menuID=" . $_GET['menuID'];
$link5 = "delete_sessions.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID . "&menuID=" . $_GET['menuID']."&pID=";
$link6 = "valid_representant.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID . "&menuID=" . $_GET['menuID'];
$link7 = "search_sessions.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID . "&menuID=" . $_GET['menuID'];
$link8 = "del_membre.php";
$link9 = "add_membre.php";
$link10 = "sample23.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID . "&menuID=" . $_GET['menuID'];
$link13 = "print_sessions.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID. "&menuID=" . $_GET['menuID']."&tab=1";
$link14 = "print_sessions.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID. "&menuID=" . $_GET['menuID']."&tab=3";
$link15 = "sample34.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID. "&menuID=" . $_GET['menuID']."&tab=4";
$link16 = "sample36.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&menuID=" . $_GET['menuID']. "&lID=" . $_GET['lID'];
$link17 = "sample42.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID. "&menuID=" . $_GET['menuID'];
$link18 = "sample44.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID. "&menuID=" . $_GET['menuID'];
$link19 = "sample54.php?aID=" . $txtYear. "&mID=" . $txtMonth . "&comID=" . $comID. "&menuID=" . $_GET['menuID']."&tab=4";
...
ORDER BY fonctions.fonction_id", GetSQLValueString($comID, "int"),GetSQLValueString($txtMonth, "text"),GetSQLValueString($txtYear, "text"));
...
mysql_select_db($database_MyFileConnect, $MyFileConnect);
$query_rsDossiers_traites = sprintf("SELECT * FROM dossier_traites WHERE dossiers_commission_id = %s AND mois = %s AND annee = %s", GetSQLValueString($comID, "int"), GetSQLValueString($txtMonth, "text"),GetSQLValueString($txtYear, "text"));
...
?>
            ...
            <input name="comID" type="hidden" id="commission_id" value="<?php echo $row_rsCommissions['commission_id']; ?>" />
            <?php
             /** Display error messages if the "commission" field is empty */
            if ($commissionIsEmpty || !isset($comID)) { ?>
        ...
        <table align="left" class="std2">
          <tr valign="baseline">
            ...
            <td><select name="mID" id="mID">
              <option value="" <?php if (!(strcmp("", $txtMonth))) {echo "selected=\"selected\"";} ?>>:: Select...</option>
              <?php do {  ?>
              <option value="<?php echo $row_rsMois['mois_id']?>"<?php if (!(strcmp($row_rsMois['mois_id'], $txtMonth))) {echo "selected=\"selected\"";} ?>> <?php echo ucfirst($row_rsMois['lib_mois']) ?></option>
              <?php
...
do {  
?>
              <option value="<?php echo $row_rsSelYear['lib_annee']?>"<?php if (!(strcmp($row_rsSelYear['lib_annee'], $txtYear))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsSelYear['lib_annee']?></option>
              <?php
...
<table>
  <tr>
    ...
    <?php if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==5)){ ?>
    ...
    <?php } ?>&nbsp;&nbsp;
      ...
      <a href="<?php echo $link2 . "&valid=mb" ?>"><img src="images/img/b_edit.png" width="16" height="16" /> Modifier</a>&nbsp;&nbsp; <a href="<?php echo $link10."&valid=mb" ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter une session</a>&nbsp;&nbsp; <a href="#"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle"/>Supprimer la session de la commission</a></BR></td>
  </tr>
</table>
<?php } ?>
<?php $count_member = MinmapDB::getInstance()->get_count_member_by_commission_id($comID); ?>
<table border="1" align="center" class="std">
  ...
  <tr>
    <td nowrap="nowrap"><?php echo $compter ?>
    <?php           
    ...
    <?php $user_group = MinmapDB::getInstance()->get_user_groupe_by_name($_SESSION['MM_Username']);
		if (isset($user_group) && $user_group == '0'){ ?>
    <td nowrap="nowrap">
        <a href="<?php echo $link5 . $row_rsSessions['personne_id']; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle"/></a><a href="maj_personnes.php?recordID=<?php echo $row_rsSessions['membres_personnes_personne_id']; ?>&amp;map=personnes"></a>
        </td><?php } ?>
    ...
    <td align="right" nowrap="nowrap"><strong><?php echo number_format($row_rsSessions['total'],0,' ',' '); ?>
      <?php $somme2 = $somme1; $somme1 = $somme1 + $row_rsSessions['total'];  ?> F CFA
    </strong></td>
  </tr>
  ...
  <table width="60%" border="1" align="center" class="std">
    ...
    <tr>
      ...
      <table align="left">
        <tr>
          ...
          <a href="#" onclick="<?php popup($link19, "1200", "700") ?>"><img src="images/img/b_print.png" width="16" height="16" />Version imprimable2</a>&nbsp; <a href="<?php echo $link16 . "&valid=mb&comID=" . $comID . "&sCom=" . $row_rsSousCommission['commission_id'] ?>"><img src="images/img/b_edit.png" width="16" height="16" /> Modifier</a>&nbsp;&nbsp;<a href="<?php echo $link10 . "&valid=scom" ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter une session</a>&nbsp;&nbsp;<a href="#"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle"/>Supprimer la session</a></td>
          </tr>
      </table>
      <?php } ?>
      </td>
    ...
    <tr>
      ...
      <td><?php $com_ID = $row_rsSousCommission['commission_id'];
	  		echo MinmapDB::getInstance()->get_dossier_ref_by_value($com_ID, $txtMonth, $txtYear); ?>&nbsp;</td>
      <td valign="top">
	  <?php
	  	$colname_rsMembres = "-1";
...
<table border="1" align="center" class="std">
  ...
  <tr>
    ...
    <td><a href="#" onclick="<?php popup($showGoToPersonnes3, "700", "400"); ?>"><?php echo htmlentities(strtoupper($row_rsSessionRepresentant['personne_nom'])); ?></a>
    	<?php //echo $user_id = (MinmapDB::getInstance()->get_user_id_by_name($_SESSION['MM_Username']));
          ...
          <img src="images/img/s_okay.png" alt="" width="16" height="16" align="absmiddle"/>
          <?php } ?>&nbsp; </td>
    <td><?php echo strtoupper($row_rsSessionRepresentant['code_structure']); ?>&nbsp; </td>
  ...
  <tr>
    ...
    <th align="right" nowrap="nowrap"><strong>
      <?php  echo number_format($sommes,0,' ',' '); ?>F CFA
    </strong></th>
  </tr>
</table>
<p>&nbsp;</p>
...
<table>
  <tr>
    ...
    <!--<form action="scriptValidate.php" method="post">-->
		...
		if (isset($etat_validate) && $etat_validate=='1' && isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==7)) { 
		$link = 'scriptControlate2.php?comID='.$comID.'&mID='.$txtMonth.'&aID='.$txtYear.'&value=';?>
        <input name="BtnValider" type="button" value="Demander modification" onclick="<?php popup($link.'0&champ=userControlate', "700", "400"); ?>">
        <input name="BtnValider" type="button" value="Valider la Saisie de l'etat de la  commission" onclick="<?php popup($link.'2&champ=userControlate', "700", "400"); ?>">
        <?php } ?>
    <!--</form>--></td>
  </tr>
</table>
...
<p></p><table width="80%" border="0" align="center">
  <tr>
    ...
    <td><?php
		...
		if (isset($etat_validate) && $etat_validate=='0' && isset($etat_controlate) && isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==7)) { ?>
      <h2>	MODIFICATION DEMANDE PAR LES SERVICES DE CONTROLE</h2>
      <?php } else if (isset($etat_validate) && $etat_validate=='2' && isset($etat_controlate) && isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==7)) {  ?>
      <h2>ETAT VALIDE PAR LES SERVICES DE CONTROLE</h2>
      <?php } else if (isset($etat_validate) && $etat_validate== NULL && isset($etat_controlate) && isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==7)) {  ?>
      <h2>DONNEES INEXISTANTES</h2>
      <?php } ?>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
</table>
