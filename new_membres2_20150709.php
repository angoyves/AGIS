...
?>
          ...
          <td align="center"><?php if (isset($row_rsPersonnes['add_commission'])) { ?>
              ...
              <a href="change_etat_index.php?comID=<?php echo $_GET['comID']; ?>&recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&map=personnes&amp;mapid=personne_id&amp;action=add_com&menuID=<?php echo $_GET['menuID']; ?>&amp;action=add_com&page=addMbr2"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
              <?php } else {?>
              <a href="change_etat_index.php?recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=add_com&menuID=<?php echo $_GET['menuID']; ?>&amp;action=add_com&page=addMbr2"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
              <?php } ?>
            <?php }  ?>
            &nbsp;
          </td>
