...
<table border="1" align="center" class="std">
  ...
  <?php do { ?>
    <tr>
      <td nowrap="nowrap">
      <a href="" onclick="window.opener.location.href='new_sous_commissions.php?menuID=<?php echo $_GET['menuID'];?>&&action=<?php echo $_GET['action'];?>&&comID=<?php echo $row_rsCommissions['commission_id']; ?>';self.close();"> <img src="images/img/b_import.png" width="16" height="16" alt="<?php echo $row_rsCommissions['commission_id']; ?>" /></a>     
