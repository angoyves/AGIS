...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO affiche_menus (user_groupe_id, menu_id) VALUES (%s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="user_groupe_id" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Menu_id:</td>
      <td><input type="text" name="menu_id" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
