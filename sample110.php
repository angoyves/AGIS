...
$colname_rsCommissions = "centrale";
if (isset($_POST['txtSearch'])) {
  $colname_rsCommissions = $_POST['txtSearch'];
}
mysql_select_db($database_MyFileConnect, $MyFileConnect);
$query_rsCommissions = sprintf("SELECT * FROM commissions WHERE commission_lib LIKE %s AND commission_parent is null ORDER BY commission_lib ASC", GetSQLValueString("%" . $colname_rsCommissions . "%", "text"));
...
<form id="form1" name="form1" method="post" action="sample110.php">
  <table border="0" class="">
    <tr>
      <td><strong>Rechercher Par :</strong></td>
      <td><select name="txtChamp" id="txtChamp">
        <option value="commission_lib" <?php if (!(strcmp("commission_lib", $colname_rsSelect1))) {echo "selected=\"selected\"";} ?>>Libelle commission</option>
    ...
    <tr>
      <td colspan="4" align="right"><a href="sample126.php">Enregistrer un paiement</a>
    ...
    <tr>
      <td colspan="4"><?php if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {?>
        Enregistrements trouv&eacute;s pour votre recherche &quot; <strong> <?php echo $_POST['txtSearch']; ?></strong> &quot; dans la colonne <strong> <?php echo $_POST['txtChamp']; ?></strong>
        <?php } ?>
        <a href="#" onclick="">
...
<table border="1" align="center" class="std">
  ...
  <?php $counter=0; do  { $counter++; ?>
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>"> 
      <td><a href="show_commissions.php?menuID=<?php echo $_GET['menuID'];?>&amp;action=<?php echo $_GET['action'];?>&amp;comID=<?php echo $row_rsCommissions['commission_id']; ?>&amp;typID=<?php echo $_GET['typID']; ?>"> <img src="images/img/b_views.png" width="16" height="16" /></a></td>
      <td><a href="sample125.php?comID=<?php echo $row_rsCommissions['commission_id']; ?>"> <?php echo $row_rsCommissions['commission_lib']; ?>&nbsp; </a></td>
      <td><?php echo $row_rsCommissions['localite_id']; ?>&nbsp; </td>
      <td><?php echo $row_rsCommissions['type_commission_id']; ?>&nbsp; </td>
      <td><?php echo $row_rsCommissions['nature_id']; ?>&nbsp; </td>
      <td><?php echo $row_rsCommissions['structure_id']; ?>&nbsp; </td>
      <td><a href="sample113.php?comID=<?php echo $row_rsCommissions['commission_id']; ?>">Effectuer un appurement</a></td>
      <td><?php echo $row_rsCommissions['montant_cumul']; ?>&nbsp; </td>
      <td><a href="sample116.php">Afficher paiements</a>&nbsp; </td>
...
<table border="0">
  <tr>
    ...
    <td><?php if ($pageNum_rsCommissions > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_rsCommissions=%d%s", $currentPage, max(0, $pageNum_rsCommissions - 1), $queryString_rsCommissions); ?>">Pr&eacute;c&eacute;dent</a>
        <?php } // Show if not first page ?></td>
