...
if (isset($_POST['answer'])) {
  ...
  $MM_redirectLoginFailed = "myconnexions.php?uID=".$userID;
  $MM_redirectLoginIsConnected = "connected.php";
  $MM_redirecttoReferrer = true;
  mysql_select_db($database_MyFileConnect, $MyFileConnect);
  	
  $LoginRS__query=sprintf("SELECT * FROM users WHERE user_login=%s AND user_answer=%s AND display='1'",
  ...
  <ul>
    <table border="0" align="center">
      <tr>
        ...
        <td width="339" scope="col"><h1><a id="logo" href="http://127.0.0.1">Retour à la boite de connexion</h1></td>
      </tr>
    </table>
  </ul>
  <form class="wufoo" action="myconnexions.php?uID=<?php echo $userID; ?>" method="POST" name="form1" id="form1">
    <ul>
      <li class="section">
        <h3></h3>
      </li>
      <li>
        <label class="desc"><?php echo strtoupper($_SESSION['MM_Username']).$userID; ?></label>
      </li>
      <li>
