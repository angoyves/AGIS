...
<table width="60%" border="0" align="center">
  ...
  <tr>
	...
	<tr>
      ...
      <tr>
        ...
        <td align="left" nowrap="nowrap"><?php echo strtoupper($row_rsSessions['banque_code'] . '-' . $row_rsSessions['agence_code'] . '-' . $row_rsSessions['numero_compte'] . '-' . $row_rsSessions['cle']); ?></td>
  ...
  <tr>
    <td colspan="3">
	<?php 	if (isset($_GET['tab']) && ($_GET['tab']==2 || $_GET['tab']==4)) { // Show if $_GET['tab'] ?>
  ...
  <table border="1" align="center" class="print">	
    ...
    <tr>
      ...
      <td nowrap="nowrap"><?php echo strtolower($row_rsSessions_sCom['banque_code'].'-'.$row_rsSessions_sCom['agence_code'].'-'.$row_rsSessions_sCom['numero_compte'].'-'.$row_rsSessions_sCom['cle']); ?></td>
  ...
  <table border="1" align="center" class="print">
    ...
    <tr>
      ...
      <td nowrap="nowrap"><?php echo strtoupper($row_rsSessionRepresentant['banque_code'].'-'.$row_rsSessionRepresentant['agence_code'].'-'.$row_rsSessionRepresentant['numero_compte'].'-'.$row_rsSessionRepresentant['cle']); ?></td>
    ...
    <tr>
      ...
      <?php $count=0; do  { $count++; ?>
      <?php }while ($count < 12); ?>
      <th colspan="2" align="right" nowrap="nowrap"><strong>Sous Total</strong></th>
