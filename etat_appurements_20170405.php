  ...
  <tr>
	...
	<tr>
      ...
      <tr>
		...
		<?php 
		$montantPaye =  MinmapDB::getInstance()->get_montant_appurement_by_rib($user_rib);
...
<tr>
  ...
  <table border="1" align="center" class="print">
    ...
    <tr>
      ...
      <?php $count++; } while ($count <= $txtMonth2) ?>
      <?php
	  	$montantPayeSco =  MinmapDB::getInstance()->get_montant_appurement_by_rib($user_rib);
  ...
  <h1>Représentant Maitre d'Ouvrage</h1>
        <table border="1" align="center" class="print">
          ...
          <tr>
            ...
            <?php $count++;  } while ($count <= $txtMonth2) ?>
            <?php 
			$montantPayeRep =  MinmapDB::getInstance()->get_montant_appurement_by_rib($user_rib);
