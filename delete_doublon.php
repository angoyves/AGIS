...
MinmapDB::getInstance()->update_record(sessions, membres_personnes_personne_id, membres_personnes_personne_id, $date, $record_id, $record_id1);// met à jour la sessions
MinmapDB::getInstance()->update_record(membres, personnes_personne_id, personnes_personne_id, $date, $record_id, $record_id1);
...
<link href="/AGIS/css/v2.css" rel="stylesheet" type="text/css" />
</head>
...
<form id="form2" name="form2" method="post" action="">
  <table width="278">
    ...
    <tr>
      ...
      <td><input name="txtSearch" type="text" id="txtSearch" value="<?php (isset($_GET['txtSearch'])?$_GET['txtSearch']:'')?>"/></td>
...
<form id="form3" name="form3" method="post" action="delete_doublon.php">
  <input type="submit" name="button" id="button" value="Reinitialiser" />
</form>
</br>
