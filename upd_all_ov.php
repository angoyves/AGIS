...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="num_virement" value="<?php echo htmlentities($row_rsUpdOV['num_virement'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td align="right" nowrap="nowrap">Montant:</td>
      <td><input type="text" name="montant" value="<?php echo htmlentities($row_rsUpdOV['montant'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td align="right" nowrap="nowrap">Annee:</td>
      <td><input type="text" name="annee" value="<?php echo htmlentities($row_rsUpdOV['annee'], ENT_COMPAT, 'utf-8'); ?>" /></td>
    </tr>
    <tr valign="baseline">
