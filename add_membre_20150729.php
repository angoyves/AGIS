    ...
    <tr>
      <td colspan="10">
        <?php           
	 	  ...
	 	  ?>
        <a href="#" onclick="<?php popup($showGoTo, "710", "450"); ?>">Ajouter  un repr&eacute;sentant de maitre d'ouvrage...<img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle" /></a>&nbsp;</td>
      </tr>
    <tr>
      <th colspan="5">N°</th>
      <th>RIB</th>
