  ...
  <table width="75%" border="0" align="center">
    <tr>
      <td><form id="form1" name="form1" method="post" action="">
        <table width="50%" align="left" class="std">
          <tr valign="baseline">
...
do {  
?>
              <option value="<?php echo $row_rsMois['mois_id']?>"<?php if (!(strcmp($row_rsMois['mois_id'], $_POST['mois']))) {echo "selected=\"selected\"";} ?>><?php echo ucfirst($row_rsMois['lib_mois']) ?></option>
              <?php
...
<table width="75%" border="1" align="left" class="std">
        <?php if (isset($_POST['mois'])) { // Show if recordset not empty ?>
        <tr valign="baseline">
    ...
    <tr>
      <td><table width="75%" border="1" class="std">
        ...
        <tr valign="baseline">
          ...
          <td nowrap="nowrap"><input name="annee1" type="text" id="annee1" value="<?php if ( isset($_POST['annee'])) { echo $_POST['annee'];} ?>" size="15" /></td>
