  ...
  <table border="1" align="center" class="std">
    ...
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      ...
      <?php $link = 'sample53.php?txtMonth1='. $txtMonth1 .'&txtMonth2='. $txtMonth2 .'&txtYear='. $txtYear .'&comID='. $row_rsCommissionsR['commission_id']; 
			...
			$link22 = 'etat_appurements_2.php?m1ID='. $txtMonth1 .'&m2ID='. $txtMonth2 .'&aID='. $txtYear .'&comID='. $row_rsCommissionsR['commission_id'];
			$link222 = 'etat_appurements_3.php?m1ID='. $txtMonth1 .'&m2ID='. $txtMonth2 .'&aID='. $txtYear .'&comID='. $row_rsCommissionsR['commission_id'] .'&txID='. $_REQUEST['taux'];
	  ?>
	  ...
	  echo GetRegionLibByTYpe($row_rsCommissionsR['type_commission_id']) .' '.strtoupper($row_rsCommissionsR['localite_lib']); 
        ...
        <?php if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==8)) { ?>
          ...
          <?php } ?>
        <?php //if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==8)) { ?>
         <!-- <a href="" onClick="<?php //popup($link22, "1200", "700"); ?>">Print recap<img src="images/img/b_print.png" width="16" height="16" border="0" /></a>-->
          <?php //} ?>
        <?php if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==8)) { ?>
          <a href="" onClick="<?php popup($link222, "1200", "700"); ?>">Etat de paiement<img src="images/img/b_print.png" width="16" height="16" border="0" /></a>
          <?php } ?>
      </td>
