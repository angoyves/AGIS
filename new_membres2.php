...
if (isset($_POST['personne_id'.$x]) && isset($_POST['fonction_id'.$x])) {
  ...
  $insertGoTo = "valid_sessions.php?&comID=".$_GET['comID']."&menuID=3&valid=mb";
  /*if (isset($_SERVER['QUERY_STRING'])) {
      ...
      <table width="60%" border="1" align="center" class="std">
        <tr>
		  ...
		  <?php if (isset($_POST['button'])) { ?>
	 	  ...
	 	  ?><a href="#" onclick="<?php popup($showGoTo, "610", "300"); ?>">Enregistrer  une personne au fichier...<img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle" /></a><?php } ?>&nbsp;</td>
        </tr>
...
?>
          ...
          <td align="center"><?php if (isset($row_rsPersonnes['add_commission'])) { ?>
              ...
              <a href="change_etat_index.php?comID=<?php echo $_GET['comID']; ?>&recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&map=personnes&amp;mapid=personne_id&amp;action=add_com&menuID=<?php echo $_GET['menuID']; ?>&amp;action=add_com&page=addMbr2&uID=<?php echo $_SESSION['MM_Username']; ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
              <?php } else {?>
              <a href="change_etat_index.php?recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=add_com&menuID=<?php echo $_GET['menuID']; ?>&amp;action=add_com&page=addMbr2&uID=<?php echo $_SESSION['MM_Username']; ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
              <?php } ?>
            <?php }  ?>
            &nbsp;
          </td>
...
?>
            ...
            if ($numberInsertIsLow) { ?>
              <div class="control"><img src="images/img/s_error.png" alt="" width="16" height="16" align="absmiddle" />Le nombre de membre pour la cr&eacute;ation d'une commission doit etre sup&eacute;rieur ou &eacute;gale &agrave; 3...Ajoutez des membres SVP!</div>
            <?php }
            ?></td>
          </tr>
          <tr>
...
?>
		...
		<?php if (isset ($_GET['comID'])) { ?> 
                      <a href="change_etat_index.php?comID=<?php echo $_GET['comID'];?>&recordID=<?php echo $row_rsPersonnesAdd['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=move_com&page=addMbr2&menuID=<?php echo $_GET['menuID']; ?>&uID=<?php echo $_SESSION['MM_Username']; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>
                      <?php } else { ?>
                      <a href="change_etat_index.php?recordID=<?php echo $row_rsPersonnesAdd['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=move_com&page=addMbr2&menuID=<?php echo $_GET['menuID']; ?>&uID=<?php echo $_SESSION['MM_Username']; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>   
          <?php } ?>
          </tr>
          <?php } // Show if recordset not empty ?>
