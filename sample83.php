...
<table border="0">
  <tr>
    <th scope="row">Afficher par  :</th>
    <td><form name="form" id="form">
      <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
        <option value="#">Seclect:::</option>
        <option value="<?php echo "sample83.php?typID=1&menuID=" . $_GET['menuID'] . "&action=" . $_GET['action'] ?>">Commission centrale</option>
        <option value="<?php echo "sample83.php?typID=2&menuID=" . $_GET['menuID'] . "&action=" . $_GET['action'] ?>">Commission ministérielle</option>
        <option value="<?php echo "sample83.php?typID=3&menuID=" . $_GET['menuID'] . "&action=" . $_GET['action'] ?>">Commission régionale</option>
        <option value="<?php echo "sample83.php?typID=4&menuID=" . $_GET['menuID'] . "&action=" . $_GET['action'] ?>">Commission départementale</option>
        <option value="<?php echo "sample83.php?typID=5&menuID=" . $_GET['menuID'] . "&action=" . $_GET['action'] ?>">Commission communale</option>
      </select>
...
<table>
  <tr>
    ...
    <?php if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup'] == 1 || $_SESSION['MM_UserGroup'] == 8)) { ?>
      <a href="delete_doublon.php"><img src="images/img/b_usrlist.png" alt="" width="16" height="16" align="absmiddle"/><span class="succes">&nbsp;Supprimer les doublons</span></a>&nbsp;
    <?php } ?>
      </td>
    <td>
    <?php if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup'] == 1 || $_SESSION['MM_UserGroup'] == 8)) { ?>
      <a href="show_all_ov.php"><img src="images/img/b_usrlist.png" alt="" width="16" height="16" align="absmiddle"/><span class="succes">&nbsp;Afficher la liste des OV</span></a>&nbsp;
    <?php } ?>&nbsp;</td>
    <td>
    <?php if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup'] == 1 || $_SESSION['MM_UserGroup'] == 8)) { ?>
      <a href="show_ov.php"><img src="images/img/b_usrlist.png" alt="" width="16" height="16" align="absmiddle"/><span class="succes">&nbsp;Modifier les commissions dans la liste des  OV</span></a>&nbsp;
      <?php } ?>&nbsp;</td>
  </tr>
</table></BR>
...
<?php //if (isset($_GET['action']) && $_GET['action'] == 'show') {?>
    ...
    <th width="117" colspan="5" nowrap="nowrap">&nbsp;</th>
<?php //} ?>
  </tr>
<?php } ?>
</form>
  <tr>
    ...
    <?php } ?>
<?php //if (isset($_GET['action']) && $_GET['action'] == 'upd') {?>
    <th colspan="7" nowrap="nowrap">Operations</th>
<?php //} ?>
<?php //if (isset($_GET['action']) && $_GET['action'] == 'show') {?>
    <?php //} ?>
  </tr>
  <?php $counter=0; do  { $counter++; 
   //$text = substr(strtoupper($row_rsCommissions['commission_lib']),-5,-1); 
  ?>
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      ...
      <?php 
	  $ovsExist = MinmapDB::getInstance()->verify_table_credentials('appurements', 'motif', substr($row_rsCommissions['commission_lib'],-5,-1));
	  ?>
...
<?php $sousCommissionID = MinmapDB::getInstance()->get_value_id_by_value(commission_id, commissions, commission_parent, $row_rsCommissions['commission_id']);?>
      ...
      <td nowrap="nowrap">&nbsp;
        <a href="view_appurements.php?&amp;comID=<?php echo $row_rsCommissions['commission_id']; ?>&amp;menuID=<?php echo $_GET['menuID']; ?>&action=new&lID=<?php echo $row_rsCommissions['localite_id']; ?>&valid=mb"><img src="images/img/b_usrlist.png" alt="" width="16" height="16" align="absmiddle"/>
    <?php echo($ovsExist?'<span class="succes">Afficher etat appurements</span>':'Afficher etat appurements');?></a>
<?php //} ?>
<?php } ?>
...
<?php $user_group = MinmapDB::getInstance()->get_user_groupe_by_name($_SESSION['MM_Username']);
	if (isset($user_group) && $user_group == '0'){ ?>
      ...
      <?php } elseif (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1)){ ?>
      ...
      <?php if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==8)){ ?>
      <td nowrap="nowrap">
      <a href="query_appurements.php?&amp;comID=<?php echo $row_rsCommissions['commission_id']; ?>&amp;menuID=<?php echo $_GET['menuID']; ?>&action=new&lID=<?php echo $row_rsCommissions['localite_id']; ?>&valid=mb"><img src="images/img/b_usrlist.png" alt="" width="16" height="16" align="absmiddle"/>
      <?php echo($ovsExist?'<span class="succes">Effectuer une requete</span>':'Effectuer une requete');?></a></td>
      <?php } ?>
<?php $user_group = MinmapDB::getInstance()->get_user_groupe_by_name($_SESSION['MM_Username']);
	if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==2 || $_SESSION['MM_UserGroup']==8)){ ?>
      <td valign="middle" nowrap="nowrap">&nbsp;&nbsp;
      <a href="#" onclick="<?php 
	  $link11 = "etat_appurements.php?comID=" . $row_rsCommissions['commission_id'] . "&m1ID=01&m2ID=12&aID=2014";
	  popup($link11, "1200", "700"); ?>"><img src="images/img/b_print.png" width="16" height="16" border="0" /><?php echo($ovsExist?'<span class="succes">Recapitulatif</span>':'Recapitulatif');?></a></td>
      <?php if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==8)){ ?>
      <td valign="middle" nowrap="nowrap">&nbsp;
      <a href="#" onclick="<?php 
	  $link11 = "show_appurements2.php?aID=" . $_POST['txt_Year']. "&mID=" . $_POST['txt_Month'] . "&comID=" . $row_rsCommissions['commission_id']. "&menuID=" . $_GET['menuID'];
	  popup($link11, "1200", "700"); ?>"><img src="images/img/b_usrlist.png" alt="" width="16" height="16" align="absmiddle"/>Afficher les paiements</a></td>
      <td valign="middle" nowrap="nowrap"><?php echo MinmapDB::getInstance()->get_region_lib_by_region_id($row_rsCommissions['region_id']) ?>&nbsp;</td>
      <?php } ?>
    </tr>
    <?php } ?>
