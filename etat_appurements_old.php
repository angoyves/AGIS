...
GROUP BY personnes.personne_id
ORDER BY personne_nom, annee, mois", GetSQLValueString($txtComID, "int"),GetSQLValueString($txtYear, "text"),GetSQLValueString($txtMonth1, "text"),GetSQLValueString($txtMonth2, "text"));
