...
<!--[if IE]>
	...
	<![endif]-->
<link href="mktree.css" rel="stylesheet" type="text/css">
<link href="mktree2.css" rel="stylesheet" type="text/css">
...
<?php //if (isset($_GET['action']) && $_GET['action'] == 'del') {?>
      ...
      <?php //} ?>
<?php //if (isset($_GET['action']) && $_GET['action'] == 'upd') {?>
      <td nowrap="nowrap"><a href="sample38.php?menuID=<?php echo $_GET['menuID'];?>&amp;action=<?php echo $_GET['action'];?>&amp;comID=<?php echo $row_rsCommissions['commission_id']; ?>&lID=<?php echo $row_rsCommissions['localite_id']; ?>"><img src="images/img/b_views.png" width="16" height="16" />Details sessions</a></td>
      <td nowrap="nowrap"><a href="sample10.php?menuID=<?php echo $_GET['menuID'];?>&amp;action=<?php echo $_GET['action'];?>&amp;comID=<?php echo $row_rsCommissions['commission_id']; ?>">Impression recapitulatif</a>&nbsp;&nbsp;</td>
      <?php //} ?>
    </tr>
