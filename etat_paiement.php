...
if ((isset($_GET['txtMonth1'])) && ($_GET['txtMonth1'] != "") && (isset($_GET['txtMonth2'])) && ($_GET['txtMonth2'] != "") && (isset($_GET['txtYear'])) && ($_GET['txtYear'] != "")) {
$colname_rstxtMonth1 = "-1";
if (isset($_GET['txtMonth1'])) {
  $colname_rstxtMonth1 = $_GET['txtMonth1'];
}
$colname_rstxtMonth2 = "-1";
if (isset($_GET['txtMonth2'])) {
  $colname_rstxtMonth2 = $_GET['txtMonth2'];
}
$colname_rstxtYear = "-1";
if (isset($_GET['txtYear'])) {
  $colname_rstxtYear = $_GET['txtYear'];
}
...
?>
      ...
      <tr>
        ...
        <td nowrap="nowrap"><?php echo $row_rsPersonnesRib['personne_telephone']; ?>&nbsp; </td>
        <td nowrap="nowrap"><?php echo $row_rsPersonnesRib['structure_lib']; ?>&nbsp; </td>
        <td nowrap="nowrap"><?php echo htmlentities($row_rsPersonnesRib['fonction_lib']); ?>&nbsp; </td>
