...
<form id="form1" name="form1" method="post" action="">
  ...
  <tr>
    ...
    <td><select name="TxtChamp" id="TxtChamp">
      ...
      <option value="telephone">N° Téléphone</option>
    </select></td>
  ...
  <tr>
    <td colspan="4"><?php if (isset($_POST['TxtSearch'])) { ?>
      Enregistrement trouvé pour votre recherche &quot; <strong> <?php echo $_POST['TxtSearch']; ?></strong> &quot; dans <strong> <?php echo $_POST['TxtChamp']; ?></strong>
      <?php } ?></td>
  </tr>
</table>
</form>
...
<table width="570" border="0" cellpadding="0" cellspacing="0" class="std">
    ...
    <tr bgcolor="#FFFFFF">
      <td height="36"><img src="images/img/s_attention.png" width="16" height="16" /> Aucun enregistrement trouvé pour votre recherche &quot; <strong> <?php echo $_POST['TxtSearch']; ?></strong> &quot; dans <strong> <?php echo $_POST['TxtChamp']; ?></strong></td>
    </tr>
    <tr bgcolor="#FFFFFF">
