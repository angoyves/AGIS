...
<table border="1" align="center" class="std">
  ...
  <?php do { ?>
    <tr>
      ...
      <?php } else { ?>
      <a href="" onclick="window.opener.location.href='valid_sessions.php?comID=<?php echo $row_rsCommissions['commission_id']; ?>';self.close();"> <img src="images/img/b_import.png" width="16" height="16" alt="<?php echo $row_rsCommissions['commission_id']; ?>" /></a>     
      <?php } ?>
