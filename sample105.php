...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/NewTemplate.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
<div class="nav-outer"> 
		...
		<div class="select_sub">
			<ul class="sub">
				<li><a href="#nogo">Utilisateurs Connectés</a></li>
				<li><a href="#nogo">Etat de saisie</a></li>
			</ul>
		</div>
		...
		<ul class="select"><li><a href="sample104.php"><b>Fichier</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li class="#nogo"><a href="sample106.php">Fichier Global</a></li>
				<li class="#nogo"><a href="sample107.php">Repertoire des experts</a></li>
				<li class="#nogo"><a href="sample108.php">Representants des Maitres d'ouvrage</a></li>
...
<div id="content-table-inner">
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Ajouter un expert</a></div>
			<div class="step-dark-right">&nbsp;</div>
			<div class="step-no-off">2</div>
			<div class="step-light-left"><a href="">Ajouter un personnel</a></div>
      ...
      <input type="hidden" name="banque_code" value="<?php echo $_GET[banqueID]; ?>" size="32" />
        </td>
        <td>
        ...
        <tr>
			...
			<td><input name="nom" type="text" class="inp-form" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Prenom:</th>
			<td><input name="prenom" type="text" class="inp-form" /></td>

		</tr>
        <tr>
			<th valign="top">Grade:</th>
			<td><input name="grade" type="text" class="inp-form" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Telephone:</th>
			<td><input name="telephone" type="text" class="inp-form" /></td>
		...
		<select  class="styledselect_form_1">
            ...
            <option value="">Personnel Services Centraux</option>
			<option value="">Personnel Services Deconcentrés</option>
			<option value="">Expert</option>
			<option value="">Representant maitre d'Ouvrage</option>
        ...
        <th>Matricule :</th>
        <td>
		<input class="inp-form" name="personne_matricule" type="text" value="<?php if ( isset($_POST['personne_matricule'])) { echo $_POST['personne_matricule'];} ?>" size="12" maxlength="8" />
        (ex :XXXXXX-X)
        <?php
        ...
        <th>Agence: </th>
        <td>
        <select class="styledselect_form_1" name="agence_code" id="select">
...
<!-- <div id="footer-pad">&nbsp;</div> -->
	<!--  start footer-left -->
	<div id="footer-left">
    Copyright Lafayette. <a href="">www.lafayette.cm</a>. All rights reserved.</div>
	<!--  end footer-left -->
	<div class="clear">&nbsp;</div>
</div>
<!-- end footer -->
