...
<form id="form1" name="form1" method="get" action="show_personnes.php?col=<?php $_GET['txtChamp'] ?>&txt=<?php $_GET['txtSearch'] ?>">
  <table border="0" align="center" >
    ...
    <tr>
      <td colspan="4"><?php echo 'Affiché : '.$maxRows_rsAffichePerson; ?>&nbsp;</td>
    </tr>
    <tr>
...
?>      </td>
	  ...
	  } else { echo strtoupper(htmlentities($row_rsAffichePerson['personne_nom'] . " " . ucfirst(htmlentities($row_rsAffichePerson['personne_prenom']))));} ?>
        &nbsp; </a></td>
      <td>
	  ...
	  <?php $user_group = MinmapDB::getInstance()->get_user_groupe_by_name($_SESSION['MM_Username']);
		if (isset($_SESSION['MM_UserGroup']) && $_SESSION['MM_UserGroup'] == '1'){ ?>
      <td align="center"><a href="maj_personnes.php?recordID=<?php echo $row_rsAffichePerson['personne_id']; ?>&&map=personnes&menuID=<?php echo $_GET['menuID']; ?>"><img src="images/img/b_edit.png" alt="" width="16" height="16" align="absmiddle"/></a></td> 
      ...
      <?php } ?>
      <td align="center"><a href="#" onClick="<?php popup($showGoToPersonnes, "700", "400"); ?>"><img src="images/img/b_view.png" alt="" width="16" height="16" align="absmiddle"/></a></td>
...
<table width="570" border="0" cellpadding="0" cellspacing="0" class="std">
  ...
  <tr bgcolor="#FFFFFF">
    <td height="36"><img src="images/img/s_attention.png" width="16" height="16" /> Aucun enregistrement trouvé pour votre recherche &quot; <strong> <?php echo $_GET['txtSearch']; ?></strong> &quot; dans <strong> <?php echo $_GET['txtChamp']; ?></strong></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
?>
      ...
      <td align="center"><?php if (isset($row_rsShowPersonInactiv['display']) && $row_rsShowPersonInactiv['display'] == '1') { ?>
        <a href="change_etat_index.php?recordID=<?php echo $row_rsShowPersonInactiv['personne_id']; ?>&amp;&amp;map=personnes&amp;&amp;mapid=personne_id&amp;&amp;action=desactive&menuID=<?php echo $_GET['menuID']; ?>"><img src="images/img/s_okay.png" alt="" width="16" height="16" align="absmiddle"/></a>
        <?php } else { ?>
        <a href="change_etat_index.php?recordID=<?php echo $row_rsShowPersonInactiv['personne_id']; ?>&amp;&amp;map=personnes&amp;&amp;mapid=personne_id&amp;&amp;action=active&menuID=<?php echo $_GET['menuID']; ?>"><img src="images/img/s_cancel.png" alt="" width="16" height="16" align="absmiddle"/></a>
      <?php } ?></td>
    <?php if (isset($_GET['action']) && $_GET['action']=='upd') { ?>
