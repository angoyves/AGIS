...
} elseif ((isset($_GET['valid']))&& ($_GET['valid']=='mb') && isset($_POST['jour'.$x]) && $_POST['jour'.$x] !="") {
...
?>
       ...
       if ($anneeIsEmpty) { ?>
        ...
        <tr valign="baseline">
          ...
          <td colspan="3" valign="top"><textarea name="dossier_id" id="dossier_id" cols="100" rows="3">3</textarea>
<?php           
