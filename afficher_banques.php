...
$query_rsBanques = "SELECT banque_code, banque_lib, date_creation, display FROM banques WHERE display = '1'";
...
<table border="0" align="center" class="std">
  <tr>
    <td colspan="3" align="left"><a href="new_banque.php?menuID=<?php echo $_GET['menuID'] ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter une Banque</a></td>
    </tr>
  <tr>
  ...
  <?php $counter=0; do  { $counter++; ?>
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      <td><a href="new_personnes.php?banqueID=<?php echo $row_rsBanques['banque_code']; ?>" target="_parent">  </a>
      	  <a href="#" onclick="window.opener.location.href='create_personnes.php?banqueID=<?php echo $row_rsBanques['banque_code']; ?>';self.close();"><?php echo $row_rsBanques['banque_code']; ?>&nbsp;</a></td>
...
<table border="0">
  <tr>
    ...
    <td><?php if ($pageNum_rsBanques > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_rsBanques=%d%s", $currentPage, max(0, $pageNum_rsBanques - 1), $queryString_rsBanques); ?>">Pr&eacute;c&eacute;dent</a>
        <?php } // Show if not first page ?></td>
