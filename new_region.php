...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO regions (region_id, region_lib, user_id, date_creation, display) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['region_id'], "int"),
                       GetSQLValueString(strtoupper($_POST['region_lib']), "text"),
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Libelle Region:</td>
      <td><input type="text" name="region_lib" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
