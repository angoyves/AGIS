...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO banques (banque_id, banque_code, banque_lib, date_creation, display) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['banque_id'], "int"),
                       GetSQLValueString($_POST['banque_code'], "text"),
                       GetSQLValueString($_POST['banque_lib'], "text"),
  ...
  $insertGoTo = "afficher_banques.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<h1>Ajouter un Banque</h1>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Code :</td>
      <td><input name="banque_code" type="text" value="" size="15" maxlength="5" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Nom Banque :</td>
      <td><input type="text" name="banque_lib" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="banque_id" value="" />
