...
?>
    ...
    <tr>
      ...
      <select name="txtRegion" id="txtRegion">
        <option value="" <?php if (!(strcmp("", ""))) {echo "selected=\"selected\"";} ?>>Toutes les Regions</option>
        <?php
do {  
?>
<option value="<?php echo $row_rsRegion['region_id']?>"<?php if (!(strcmp($row_rsRegion['region_id'], ""))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsRegion['region_lib']?></option>
        <?php
...
<table border="0" align="center">
  ...
  <?php do { ?>
    <tr align="center" class="control">
      <td><a href="sample38.php?menuID=4&action=&comID=<?php echo $row_rsSelSessions['membres_commissions_commission_id']; ?>&lID=2&aID=<?php echo $row_rsSelSessions['annee']; ?>&mID=<?php echo $row_rsSelSessions['mois']; ?>"><h3><img src="images/Icones/ico_forum.png" width="32" height="30">Demande de modification de l'etat du mois de <?php echo MinmapDB::getInstance()->get_mois_lib($row_rsSelSessions['mois']); ?>&nbsp;<?php echo $row_rsSelSessions['annee']; ?>&nbsp; de la <?php echo MinmapDB::getInstance()->get_commission_lib_by_commission_id($row_rsSelSessions['membres_commissions_commission_id']); ?> par les services du controle.</h3></a></td>
