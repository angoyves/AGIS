...
{*/
 $insertSQL = sprintf("INSERT INTO membres (commissions_commission_id, fonctions_fonction_id, personnes_personne_id, montant, checboxName, position) VALUES (%s, %s, %s, %s, %s, %s)",
...
<?php }
  ...
  <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
    ...
    <td align="center"><?php if (isset ($_GET['comID'])) { ?> 
      ...
      <?php } else { ?>
      <a href="change_etat_membre.php?recordID=<?php echo $row_rsPersonnesAdd['personne_id']; ?>&amp;&amp;map=personnes&amp;&amp;mapid=personne_id&amp;&amp;action=move_com&page=addMbr&fID=<?php echo $_GET['comID']; ?>&pID=<?php echo $_GET['pID=']; ?>&aID=<?php echo $_GET['aID']; ?>&mID=<?php echo $_GET['mID']; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>   
      <?php } ?>&nbsp;</td>
  </tr>
