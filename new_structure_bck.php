...
do {  
?>
        <option value="<?php echo $row_rsLocalite['localite_id']?>"<?php if (!(strcmp($row_rsLocalite['localite_id'], $_GET['locID']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsLocalite['localite_lib']?></option>
        <?php
