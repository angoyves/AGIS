...
if($_SERVER['HTTP_REFERER'] != 'http://127.0.0.1/AGIS/send_email.php')
{
header('Location: http://127.0.0.1/AGIS');
}
...
/* Si aucun problème et aucun cookie créé, on construit le message et on envoie
elseif (!isset($_COOKIE['sent']))
{
/* Destinataire (votre adresse e-mail) */
$to = 'angoyves@yahoo.fr';
...
/* Cas où le cookie est créé et que la page est rafraichie, on détruit la variable */
else
{
unset($_POST);
}
