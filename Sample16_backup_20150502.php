    ...
    <h1>Dossiers</h1>
      <table width="50%" border="1" align="center" class="std">
        ...
        <tr>
          ...
          <?php $counte = 0; do { $counte++; ?>
          <td align="center"><?php           
			$showGoTo2 = "dossiers.php";
			if (isset($_SERVER['QUERY_STRING'])) {
				$showGoTo .= (strpos($showGoTo, '?')) ? "&" : "?";
				$showGoTo .= $_SERVER['QUERY_STRING'];
			} ?><a href="" onclick="<?php popup($showGoTo2, "610", "300"); ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle" /></a>&nbsp;</th>
          <?php } while($counte < $row_rsJourMois['nbre_jour']); ?>
        </tr>
      </table></td>
  </tr>
  <tr>
...
<input type="hidden" name="fonction_id" id="fonction_id" value="41"/>
      ...
      <p>Enregistrements <?php echo ($startRow_rsMembres + 1) ?> à <?php echo min($startRow_rsMembres + $maxRows_rsMembres, $totalRows_rsMembres) ?> sur <?php echo $totalRows_rsMembres ?> </p>
     <?php } //fin ?> 
      </td>
  </tr>
  <tr>
...
<table border="1" align="center" class="std">
        <tr>
          <td colspan="<?php echo ($row_rsJourMois['nbre_jour']+4) ?>"><?php           
	 	  ...
	 	  ?>
            <a href="#" onclick="<?php popup($showGoTo, "610", "450"); ?>">Rechercher un repr&eacute;sentant...<img src="images/img/b_views.png" alt="" width="16" height="16" align="absmiddle" /></a>&nbsp;<strong>&nbsp;</strong><strong>&nbsp;</strong></td>
          </tr>
        <tr>
