...
AND userControlate is not null
  ...
  <tr>
	...
	<tr>
      ...
      <tr>
        ...
        <td align="right" nowrap="nowrap"><?php echo number_format(($net_percu_1 = $somme-$retenu),0,' ',' '); ?><?php $net_global_1 = $net_global_1 + $net_percu_1; ?><?php $somme1 = $somme; $somme = $somme + $row_rsSessions['total']; ?></td>
      </tr>
...
<tr>
  ...
  <table width="50%" border="1" align="center" class="print">
    ...
    <tr>
	  ...
	  ?></td>
      <td align="right" nowrap="nowrap">
	  <?php echo number_format(($net_percu_3 = $row_rsSessions_sCom['total']-$retenu_3),0,' ',' ');//$row_rsSessions_sCom['nombre_jour']; 
	  $net_percu_global_3 = $net_percu_global_3+$net_percu_3; ?>
      </td>
      </tr>
  ...
  <h1>Représentant Maitre d'Ouvrage</h1>
        <table border="1" align="center" class="print">
          ...
          <tr>
            ...
            <td align="right">
				<?php echo number_format($net_percu_2 = $Montant-$retenu_2,0,' ',' '); ?><?php $net_percu_global_2 = $net_percu_global_2+$net_percu_2; ?></td>
          </tr>
  ...
  <tr>
    <td colspan="3"><table border="0" align="center" class="print">
	  ...
	  <tr>
        ...
        <td align="right"><strong><?php echo number_format($retenu_global_1+$retenu_global_2+$retenu_global_2,0,' ',' ') //echo number_format($montant2,0,' ',' '); ?>&nbsp;</strong></td>
      </tr>
