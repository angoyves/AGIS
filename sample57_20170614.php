  ...
  <table width="60%" border="1" align="center" class="std">
    ...
    <tr>
      ...
      <td><?php $com_ID = $row_rsSousCommission['commission_id'];
	  		echo MinmapDB::getInstance()->get_dossier_ref_by_value($com_ID, $_POST['txt_Month'], $_POST['txt_Year']); ?>&nbsp;</td>
      <td valign="top">
	  <?php
	  	$colname_rsMembres = "-1";
...
<table>
  <tr>
    ...
    <!--<form action="scriptValidate.php" method="post">-->
		...
		$link = 'scriptControlate2.php?comID='.$_GET['comID'].'&mID='.$_POST['txt_Month'].'&aID='.$_POST['txt_Year'].'&value=';?>
