...
<table>
  <tr>
    ...
    <?php if (isset($user_group) && $user_group==2){ ?>
    <a href="#" onclick="<?php popup($link11, "1200", "700") ?>"><img src="images/img/b_print.png" width="16" height="16" /> Imprimer Recapitulatif </a>
    <?php }else{ ?>
	<a href="#" onclick="<?php popup($link17, "1200", "700") ?>"><img src="images/img/b_print.png" width="16" height="16" /> Imprimer Recapitulatif </a>
	<?php } ?>&nbsp;&nbsp;
...
<table border="1" align="center" class="std">
  ...
  <tr>
    ...
    <td><?php echo strtoupper($row_rsSessions['personne_nom'] . " " . ucfirst(strtolower($row_rsSessions['personne_prenom']))); ?>&nbsp; </td>
  ...
  <table width="60%" border="1" align="center" class="std">
	...
	?>
        <table width="100%" align="left" id="*">
          ...
          <?php do { ?>
            <tr>
              <td nowrap><a href="detail_membres_scom.php?recordID=<?php echo $row_rsMembres['commissions_commission_id']; ?>"><?php echo strtoupper(MinmapDB::getInstance()->get_personne_name_by_person_id($row_rsMembres['personnes_personne_id'])); ?></a></td>
