...
if (trim($txtYear) == '')
	  ...
	  mysql_select_db($database_MyFileConnect, $MyFileConnect);
		$query_rsSessions = sprintf("SELECT commission_id, commission_lib, type_commission_id, fonctions.fonction_id, personnes.personne_id, personne_nom, personne_prenom, fonction_lib, personne_telephone, nombre_jour, jour, mois, annee, montant, (nombre_jour * montant) as total, agence_cle, banque_code, agence_code, numero_compte, cle
