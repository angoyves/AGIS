...
<table border="1" align="center" class="std">
  ...
  <tr>
    ...
    <?php } else { ?>
    <td colspan="2" align="center"><strong>Nombre de dossiers trait&eacute;s</strong></td>
    <?php } ?>
    <?php  
  ...
  <tr>
    ...
    <?php $showGoToMembre = "upd_membre.php?persID=" . $row_rsSessions['personne_id'] . "&comID=".$_GET['comID']."&foncID=".$row_rsSessions['fonction_id'] ; ?>
...
<table border="1" align="center" class="std">
  ...
  <tr>
    ...
    <?php $showGoToMembre = "upd_membre.php?persID=" . $row_rsSessionRepresentant['personne_id'] . "&comID=".$_GET['comID']."&foncID=".$row_rsSessionRepresentant['fonction_id'] ; ?>
...
<table>
  <tr>
    ...
    <!--<form action="scriptValidate.php" method="post">-->
		...
		$link = 'scriptControlate2.php?comID='.$_GET['comID'].'&mID='.$_POST['txt_Month'].'&aID='.$_POST['txt_Year'].'&value=1&champ=userValidate'; ?>
