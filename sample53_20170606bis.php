	...
	<tr>
      ...
      <tr>
        ...
        <td align="right" nowrap="nowrap"><?php 
					...
					//}
				$nombre_jours = MinmapDB::getInstance()->get_nombre_jour_by_values($row_rsSessions['commission_id'], $row_rsSessions['personne_id'], $count, $txtYear);
    ...
    <tr>
      ...
      <td align="right" nowrap="nowrap">
			<?php 
				...
				$nombre_jours = MinmapDB::getInstance()->get_nombre_jour_sCom_by_values($comID, $row_rsSessions_sCom['personne_id'], $count, $txtYear);
				if (isset($nombre_jours))
				{ 
					echo $nombre_jours;
					$sommer = $sommer + $nombre_jours;
	  ...
	  <?php 
		...
		$somme2 = $row_rsSessions_sCom['montant']*$sommer; 
	  	...
	  	$Montant_global2 = $Montant_global2 + $somme2;
		
		?>
      </td>
      <td align="right" nowrap="nowrap"><?php echo number_format(($retenu_3 = $somme2*$_SESSION['MM_Retenu']),0,' ',' ');//$row_rsSessions_sCom['nombre_jour']; 
	  $retenu_global_3 = $retenu_global_3 + $retenu_3;
	  ?></td>
      <td align="right" nowrap="nowrap">
	  <strong><?php echo number_format(($net_percu_3 = $somme2-$retenu_3),0,' ',' ');//$row_rsSessions_sCom['nombre_jour']; 
