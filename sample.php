...
$colname2_rsMembres = "-1";
if (isset($_GET['aID'])) {
  $colname2_rsMembres = $_GET['aID'];
}
$colname1_rsMembres = "-1";
if (isset($_GET['mID'])) {
  $colname1_rsMembres = $_GET['mID'];
}
mysql_select_db($database_MyFileConnect, $MyFileConnect);
$query_rsMembres = sprintf("SELECT membres_personnes_personne_id, personne_nom, personne_prenom,   membres_commissions_commission_id,  membres_fonctions_fonction_id, sessions.membres_fonctions_fonction_id, fonction_lib,   lib_nature, type_commission_lib, localite_lib, nombre_jour, jour, mois, annee,  montant,(nombre_jour * montant) as total  FROM sessions, personnes, commissions, fonctions, natures, type_commissions, localites, membres  WHERE sessions.membres_personnes_personne_id = personnes.personne_id   AND sessions.membres_commissions_commission_id = commissions.commission_id  AND sessions.membres_fonctions_fonction_id = fonctions.fonction_id  AND sessions.membres_personnes_personne_id = membres.personnes_personne_id   AND commissions.nature_id = natures.nature_id    AND commissions.type_commission_id = type_commissions.type_commission_id    AND commissions.localite_id = localites.localite_id  AND membres_commissions_commission_id = %s AND mois = %s AND annee = %s AND sessions.membres_fonctions_fonction_id <> 4", GetSQLValueString($colname_rsMembres, "text"),GetSQLValueString($colname1_rsMembres, "int"),GetSQLValueString($colname2_rsMembres, "int"));
  ...
  <?php $counter=0; do  { $counter++; ?>
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      ...
      <td align="center"><?php if (isset($row_rsPersonnes['add_commission'])) { ?>
          ...
          <a href="change_etat_index.php?comID=<?php echo $_GET['comID']; ?>&&recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&map=personnes&amp;mapid=personne_id&amp;action=add_com&page=addMbr&fID=<?php echo $_GET['comID']; ?>&pID=<?php echo $_GET['pID=']; ?>&aID=<?php echo $_GET['aID']; ?>&mID=<?php echo $_GET['mID']; ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
          <?php } else {?>
          <a href="change_etat_index.php?recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=add_com&page=addMbr&fID=<?php echo $_GET['comID']; ?>&pID=<?php echo $_GET['pID=']; ?>&aID=<?php echo $_GET['aID']; ?>&mID=<?php echo $_GET['mID']; ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
          <?php } ?>
        <?php }  ?>
  &nbsp;
    </td>
...
<?php }
  ...
  <tr>
    <td colspan="9">Membres existant</td>
  </tr>
  <tr>
    <td colspan="9">&nbsp;
      <table width="80%" border="1" align="center" class="std">
        <tr>
          <th>ID</th>
          <th>Nom</th>
          <th>Prenom</th>
        ...
        <?php do { ?>
          <tr>
            <td nowrap="nowrap"><a href="todelete.php?recordID=<?php echo $row_rsMembres['membres_personnes_personne_id']; ?>"> <?php echo $row_rsMembres['membres_personnes_personne_id']; ?>&nbsp; </a></td>
            <td nowrap="nowrap"><?php echo $row_rsMembres['personne_nom']; ?>&nbsp; </td>
            <td nowrap="nowrap"><?php echo $row_rsMembres['personne_prenom']; ?>&nbsp; </td>
            <td nowrap="nowrap"><?php echo $row_rsMembres['fonction_lib']; ?>&nbsp; </td>
          </tr>
...
?>
    ...
    <td align="right" nowrap><input type="text" name="<?php echo "montant_id" . $counter ?>" id="<?php echo "personne_id" . $counter ?>" value="100000" align="right"/>
    &nbsp;</td>
    <td nowrap>
      <?php if (isset ($_GET['comID'])) { ?> 
      <a href="change_etat_index.php?comID=<?php echo $_GET['comID'];?>&&recordID=<?php echo $row_rsPersonnesAdd['personne_id']; ?>&amp;&amp;map=personnes&amp;&amp;mapid=personne_id&amp;&amp;action=move_com&page=addMbr&fID=<?php echo $_GET['comID']; ?>&pID=<?php echo $_GET['pID=']; ?>&aID=<?php echo $_GET['aID']; ?>&mID=<?php echo $_GET['mID']; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>
      <?php } else { ?>
      <a href="change_etat_index.php?recordID=<?php echo $row_rsPersonnesAdd['personne_id']; ?>&amp;&amp;map=personnes&amp;&amp;mapid=personne_id&amp;&amp;action=move_com&page=addMbr&fID=<?php echo $_GET['comID']; ?>&pID=<?php echo $_GET['pID=']; ?>&aID=<?php echo $_GET['aID']; ?>&mID=<?php echo $_GET['mID']; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>   
      <?php } ?>
  </tr>
