...
<body>
<a href="#" onclick="window.print()" title="Imprimer cette page">Imprimer<img src="img/b_print.png" alt="print" width="16" height="16" hspace="2" vspace="2" border="0" align="absmiddle" /></a>
...
<tr>
      <td colspan="7"><?php echo MinmapDB::getInstance()->get_commission_lib_by_commission_id($row_rsSessions_sCom['commission_id']); ?>&nbsp;</td>
      </tr>
    <tr>
    ...
    <table border="0" align="center" class="print">
      ...
      <tr>
        ...
        <th align="right"><strong>
          <?php  echo number_format($sommes + $sommes,0,' ',' '); ?>
          &nbsp;</strong></th>
      </tr>
    </table>
