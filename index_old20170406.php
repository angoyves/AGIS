...
?>
    ...
    <tr>
      ...
      <select name="txtRegion" id="txtRegion">
        <option value="" <?php if (!(strcmp("", 11))) {echo "selected=\"selected\"";} ?>>Toutes les Regions</option>
        <?php
do {  
?>
<option value="<?php echo $row_rsRegion['region_id']?>"<?php if (!(strcmp($row_rsRegion['region_id'], 11))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsRegion['region_lib']?></option>
        <?php
...
<table border="1" align="center" class="std">
  ...
  <?php $somme_total=0; $count=0; do { $count++; ?>
    <tr>
      <td height="23" colspan="8" align="center"><strong>REGION : <?php echo $row_rsRegions['region_lib']; ?></strong>&nbsp;   </td>
    </tr>
    <?php 
    mysql_select_db($database_MyFileConnect, $MyFileConnect);
    ...
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      ...
      <td nowrap><a href="" onClick="<?php popup($link, "1200", "700"); ?>"><?php echo GetRegionLibByTYpe($row_rsCommissionsR['type_commission_id']) .' '.strtoupper($row_rsCommissionsR['localite_lib']); ?></a></td>
