...
?>
          ...
          <td align="center"><?php if (isset($row_rsPersonnes['add_commission'])) { ?>
              ...
              <a href="change_etat_index.php?comID=<?php echo $_GET['comID']; ?>&recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&map=personnes&amp;mapid=personne_id&amp;action=add_com&menuID=<?php echo $_GET['menuID']; ?>"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
              <?php } else {?>
              <a href="change_etat_index.php?recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=add_com&menuID=<?php echo $_GET['menuID']; ?>"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
              <?php } ?>
            <?php }  ?>
            &nbsp;
          </td>
...
?>
            ...
            if ($numberInsertIsLow) { ?>
              <div class="control"><img src="img/s_error.png" alt="" width="16" height="16" align="absmiddle" />Le nombre de membre pour la cr&eacute;ation d'une commission doit etre sup&eacute;rieur ou &eacute;gale &agrave; 4...Ajoutez des membres SVP!</div>
            <?php }
            ?></td>
          </tr>
          <tr>
...
?>
            ...
            <td nowrap>
              <?php if (isset ($_GET['comID'])) { ?> 
              <a href="change_etat_index.php?comID=<?php echo $_GET['comID'];?>&recordID=<?php echo $row_rsPersonnesAdd['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=move_com&menuID=<?php echo $_GET['menuID']; ?>"><img src="img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>
              <?php } else { ?>
              <a href="change_etat_index.php?recordID=<?php echo $row_rsPersonnesAdd['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=move_com&menuID=<?php echo $_GET['menuID']; ?>"><img src="img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>   
          <?php } ?>
          </tr>
          <?php } // Show if recordset not empty ?>
