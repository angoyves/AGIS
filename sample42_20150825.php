...
mysql_select_db($database_MyFileConnect, $MyFileConnect);
$query_rsSessions_sCom = sprintf("SELECT distinct(personnes.personne_id), personne_nom, fonctions.fonction_id, fonction_lib, nombre_jour, annee, montant, (nombre_jour * montant) as total, agence_cle, banque_code, agence_code, numero_compte
FROM sessions, membres, commissions, personnes, fonctions, rib
