...
<tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
	  ...
	  $insertGoTo = "affecter_membres.php?" . $_GET['link1'] . "=". $row_rsPersonnes['personne_id'];
	  if (isset($_SERVER['QUERY_STRING'])) {
		$insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
		$insertGoTo .= $_SERVER['QUERY_STRING'];
	  }
	  echo $insertGoTo; ?>';self.close();"> <?php echo $row_rsPersonnes['personne_id']; ?>&nbsp; </a></p>
  <p><a href="<?php echo "affecter_membres.php?" . $_GET['link'] . "=" . $row_rsPersonnes['personne_id'];?>">lien</a></p></td>
