...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <p>&nbsp;</p>
  <input type="hidden" name="param_id" value="<?php echo $row_rsParams['param_id']; ?>" />
  <input type="hidden" name="MM_update" value="form1" />
  <input type="hidden" name="param_id" value="<?php echo $row_rsParams['param_id']; ?>" />
</form>
<p>&nbsp;</p>
<table width="35%" border="1" align="center" class="std">
  <tr>
    <th colspan="2" align="center"><strong>Operation</strong></th>
    <th align="center"><strong>Retenu</strong></th>
    <th align="center"><strong>Exercice</strong></th>
    <th align="center"><strong>Taux</strong></th>
  </tr>
  <?php $counter=0; do  { $counter++;  ?>
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      <td align="center"><a href="#" onclick="<?php popup("insparams.php?recordID=".$row_RsParams['param_id'], "700", "400"); ?>"> Ajouter<img src="images/img/b_insrow.png" alt="" width="16" height="16" border="0" align="absmiddle"/> </a>&nbsp;</td>
      <td align="center"><a href="#" onclick="<?php popup("insparams.php?recordID=".$row_RsParams['param_id'], "700", "400"); ?>"> Modifier<img src="images/img/b_edit.png" alt="" width="16" height="16" border="0" align="absmiddle"/></a>&nbsp;</td>
      <td align="center"><?php echo $row_RsParams['retenu']; ?>&nbsp; </td>
      <td align="center"><?php echo $row_RsParams['Exercice']; ?>&nbsp; </td>
      <td align="center"><?php echo $row_RsParams['Taux']; ?>&nbsp; </td>
    </tr>
