 ...
 <table border="1" align="center" class="print">
    ...
    <tr>
      ...
      <?php
		...
		$montanSessionsSco = GetMontantMembreSessionsSousCommission2($txtComID, $row_rsSessions_sCom['personne_id'], $row_rsSessions_sCom['fonctions_fonction_id'], $txtMonth1, $txtMonth2, $txtYear, $row_rsSessions_sCom['commission_id']);
      ...
      <td align="right" nowrap="nowrap"><?php //echo number_format($montanSessionsSco,0,' ',' '); ?><?php  echo number_format($montanSessionsSco,0,' ',' ');; ?>&nbsp;</td>
  ...
  <h1>Représentant Maitre d'Ouvrage</h1>
        <table border="1" align="center" class="print">
          ...
          <tr>
            ...
            <td align="left" nowrap="nowrap">
            <a href="#" onclick="<?php popup($showGoToPersonnes33, "700", "400"); ?>">
            ...
            <?php $count++;  } while ($count <= $txtMonth2) ?>
            <?php 
			$txtSearch = substr($row_rsSessionRepresentant['personne_nom'],0,5);
			$montantPayeRep =  MinmapDB::getInstance()->get_montant_appurement_by_rib($user_rib, $txtSearch, $txtComID, $txtYear);
            ...
            <td align="right"><strong><?php echo number_format($netAPercevoirRep,0,' ',' '); ?></strong>&nbsp;</td>
          </tr>
