...
mysql_select_db($database_MyFileConnect, $MyFileConnect);
$query_rsSessions_sCom = sprintf("SELECT commission_id, personne_nom, fonction_lib, nombre_jour, jour, mois, annee, montant, (nombre_jour * montant) as total
...
<table width="60%" border="0" align="center">
  ...
  <tr>
	...
	<tr>
      ...
      <tr>
        ...
        <td align="right" nowrap="nowrap"><?php $somme = $row_rsSessions['montant']*$sommer; $montant2=$montant; $montant = $montant + $somme;  echo number_format(($somme),0,' ',' '); ?><strong>
    ...
    <?php } while ($row_rsSessions = mysql_fetch_assoc($rsSessions)); ?>
      <tr>
        ...
        <th align="right" nowrap="nowrap"><strong>
          <?php $total = -($montant-($row_rsCountIndemnity['total'])); echo number_format(($montant2),0,' ',' ')//$somme = $somme - $row_rsCountIndemnity['total']; echo number_format($somme,0,' ',' '); ?>
        </strong></th>
      </tr>
  ...
  <table border="1" align="center" class="print">
    ...
    <tr>
      ...
      <td align="left" nowrap="nowrap"><?php echo strtoupper($row_rsSessions_sCom['personne_nom']). " " . $row_rsSessions_sCom['personne_prenom']; ?>&nbsp; </td>
      ...
      <td align="right" nowrap="nowrap"><strong><?php echo number_format($row_rsSessions_sCom['total'],0,' ',' '); ?></strong>
        <?php $somme3 = $somme3 + $row_rsSessions_sCom['total']; ?></td>
      </tr>
  ...
  <h1>Représentant Maitre d'Ouvrage</h1>
        <table border="1" align="center" class="print">
          ...
          <tr>
            ...
            <td align="right"><?php $sommes = $sommes*$row_rsSessionRepresentant['montant']; $montants = $montants + $sommes; echo number_format($sommes,0,' ',' '); ?>&nbsp; </td>
            </tr>
  ...
  <tr>
    <td colspan="3"><table border="0" align="center" class="print">
      <tr>
        ...
        <td align="right"><strong><?php echo number_format($montants,0,' ',' '); ?>&nbsp;</strong></td>
      </tr>
      <tr>
	  ...
	  <tr>
        ...
        <td align="right"><strong><?php echo number_format($montant2,0,' ',' '); ?>&nbsp;</strong></td>
      </tr>
      <tr>
        <th>Total G&eacute;n&eacute;ral</th>
        <th align="right"><strong>
          <?php  echo number_format($montants + $somme3 + $montant2,0,' ',' '); ?>
          </strong></th>
      </tr>
    </table></td>
  </tr>
