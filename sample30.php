  ...
  <?php $counter=0; do  { $counter++; ?>
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      ...
      <td align="center"><?php if (isset($row_rsPersonnes['add_commission'])) { ?>
          ...
          <a href="sample33.php?comID=<?php echo $_GET['comID']; ?>&pID=<?php echo $row_rsPersonnes['personne_id']; ?>&uID=<?php echo $_GET['uID'] ?>&map=personnes&amp;mapid=personne_id&amp;action=add_com&page=addMbr3&fID=<?php echo $_GET['comID']; ?>&aID=<?php echo $_GET['aID']; ?>&mID=<?php echo $_GET['mID']; ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
          <?php } else {?>
    ...
    <td colspan="5"><table width="100%" border="1" align="left">
      ...
      <tr>
        ...
        <?php           
			...
			$showGoTo = "add_structures.php?txt=".$_POST['txt_search'];
