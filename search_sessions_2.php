...
?>
            <a href="#" onclick="<?php popup($showGoTo, "610", "300"); ?>"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle" /></a><br/>
            <strong>
            ...
            <div class="control"><img src="img/s_attention.png" alt="" width="16" height="16" align="absmiddle" />Choose commission, please</div>
            <?php }
            ?>
        ...
        <tr>
          <td nowrap="nowrap"><img src="img/b_views.png" alt="" width="16" height="16" /></td>
          <td nowrap="nowrap"><a href="#"><img src="img/b_drop.png" alt="" width="16" height="16" align="absmiddle"/></a>&nbsp;</td>
    ...
    <table align="left" class="std2">
      <tr valign="baseline">
       ...
       if ($moisIsEmpty) { ?>
          <div class="control"><img src="img/s_attention.png" alt="" width="16" height="16" align="absmiddle" />Select month, please</div>
          <?php  } ?>
          </td>      
      </tr>
...
?>
          ...
          <?php
             /** Display error messages if the "password" field is empty */
       if ($anneeIsEmpty) { ?>
          <div class="control"><img src="img/s_attention.png" alt="" width="16" height="16" align="absmiddle" />Enter the YEAR, please</div>
          <?php  } ?>
      </td>
...
<table>
	<tr>
    	<td>
    	<a href="#" onclick="<?php popup($link13, "1200", "700") ?>"><img src="img/b_print.png" width="16" height="16" /> Version imprimable</a>&nbsp;
        <a href="#" onclick="<?php popup($link, "1200", "700") ?>"><img src="img/b_print.png" width="16" height="16" /> Imprimer Etat</a>&nbsp;
    	<a href="#" onclick="<?php popup($link11, "1200", "700") ?>"><img src="img/b_print.png" width="16" height="16" /> Imprimer Recapitulatif </a>&nbsp;&nbsp;  
        <!--<a href="#" onclick="<?php //popup($link12, "1200", "700") ?>"><img src="img/b_print.png" width="16" height="16" />Version imprimable22</a>&nbsp;&nbsp;-->
        <a href="<?php echo $link2 . "&valid=mb" ?>"><img src="img/b_edit.png" width="16" height="16" /> Modifier</a>&nbsp;&nbsp;
        <a href="<?php echo $link10."&valid=mb" ?>"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter une session</a>&nbsp;&nbsp;
        <a href="#"><img src="img/b_drop.png" alt="" width="16" height="16" align="absmiddle"/>Supprimer la session de la commission</a></BR>
    	</td>
	</tr>
</table>
  ...
  <table border="1" align="center" class="std">
    ...
    <tr>
      ...
      <td nowrap="nowrap"><a href="<?php echo $link5 . $row_rsSessions['personne_id']; ?>"><img src="img/b_drop.png" alt="" width="16" height="16" align="absmiddle"/></a><a href="maj_personnes.php?recordID=<?php echo $row_rsSessions['membres_personnes_personne_id']; ?>&map=personnes"></a></td>
...
<table>
  ...
  <table border="1" align="center" class="std">
    <tr>
      <th>ID</th>
      <th>N&deg; et Objet du DAO</th>
      <th>Nom et Prenom</th>
      <th>Fonction</th>
      <th>Montant projet</th>
      <th>Nombre de soumissionnaires</th>
      <th>Taux</th>
      <th>Montant</th>
    </tr>
  ...
  <?php if ($totalRows_rsSessionRepresentant > 0) { // Show if recordset not empty ?>
    ...
    <table>
      <tr>
        <td><a href="#" onclick="<?php popup($link14, "1200", "700") ?>"><img src="img/b_print.png" width="16" height="16" />Version imprimable</a>&nbsp;&nbsp;<a href="<?php echo $link2 . "&valid=mo" ?>"><img src="img/b_edit.png" width="16" height="16" /> Modifier</a><a href="change_etat_index.php?recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&amp;map=personnes&amp;&amp;mapid=personne_id&amp;action=add_com&amp;page=rep"></a>&nbsp;&nbsp;<a href="<?php echo $link10 . "&valid=mo" ?>"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/>Ajouter une session</a>&nbsp;&nbsp;<a href="#"><img src="img/b_drop.png" alt="" width="16" height="16" align="absmiddle"/>Supprimer les sessions de tous les repr&eacute;sentant</a></td>
      </tr>
    </table>
