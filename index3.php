...
mysql_select_db($database_MyFileConnect, $MyFileConnect);
$query_rsUsers = "SELECT user_id, user_name, user_lastname, users.structure_id, user_groupe_id, structure_lib, compteur, date_last_login, users.display FROM users, structures WHERE users.structure_id = structures.structure_id";
