...
function GetMontantValue($theCommission_type_id, $thefonction_id )  
{
...
//if (isset($theCommission_type_id) && $theCommission_type_id != 6) {
 $insertSQL = sprintf("INSERT INTO membres (commissions_commission_id, fonctions_fonction_id, personnes_personne_id, montant, checboxName, position, dateCreation, display) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString($montant_indemnite, "text"),
...
if (isset($_POST['personne_id1']) && isset($_POST['fonction_id1'])) {
 $insertSQL1 = sprintf("INSERT INTO membres (commissions_commission_id, fonctions_fonction_id, personnes_personne_id, montant, checboxName, position, dateCreation) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['commission_id'], "int"),
                       GetSQLValueString($_POST['fonction_id1'], "int"),
                       GetSQLValueString($_POST['personne_id1'], "int"),
					   GetMontantValue($typeCommission_id, GetSQLValueString($_POST['fonction_id1'], "int")),
					   GetSQLValueString("un", "text"),
                       GetSQLValueString(1, "int"),
					   GetSQLValueString($date, "date"));  }

 if (isset($_POST['personne_id2']) && isset($_POST['fonction_id2'])) {
 $insertSQL2 = sprintf("INSERT INTO membres (commissions_commission_id, fonctions_fonction_id, personnes_personne_id, montant, checboxName, position, dateCreation) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['commission_id'], "int"),
                       GetSQLValueString($_POST['fonction_id2'], "int"),
                       GetSQLValueString($_POST['personne_id2'], "int"),
					   GetMontantValue($typeCommission_id, GetSQLValueString($_POST['fonction_id2'], "int")),
					   GetSQLValueString("deux", "text"),
                       GetSQLValueString(2, "int"),
					   GetSQLValueString($date, "date")); }

if (isset($_POST['personne_id3']) && isset($_POST['fonction_id3']))	{				   
  $insertSQL3 = sprintf("INSERT INTO membres (commissions_commission_id, fonctions_fonction_id, personnes_personne_id, montant, checboxName, position, dateCreation) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['commission_id'], "int"),
                       GetSQLValueString($_POST['fonction_id3'], "int"),
                       GetSQLValueString($_POST['personne_id3'], "int"),
					   GetMontantValue($typeCommission_id, GetSQLValueString($_POST['fonction_id3'], "int")),
					   GetSQLValueString("trois", "text"),
                       GetSQLValueString(3, "int"),
					   GetSQLValueString($date, "date")); }

if (isset($_POST['personne_id4']) && isset($_POST['fonction_id4']))	{				   
  $insertSQL4 = sprintf("INSERT INTO membres (commissions_commission_id, fonctions_fonction_id, personnes_personne_id, montant, checboxName, position, dateCreation) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['commission_id'], "int"),
                       GetSQLValueString($_POST['fonction_id4'], "int"),
                       GetSQLValueString($_POST['personne_id4'], "int"),
					   GetMontantValue($typeCommission_id, GetSQLValueString($_POST['fonction_id4'], "int")),
					   GetSQLValueString("quatre", "text"),
                       GetSQLValueString(4, "int"),
					   GetSQLValueString($date, "date")); }

if (isset($_POST['personne_id5']) && isset($_POST['fonction_id5']))	{				   
  $insertSQL5 = sprintf("INSERT INTO membres (commissions_commission_id, fonctions_fonction_id, personnes_personne_id, montant, checboxName, position, dateCreation) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['commission_id'], "int"),
                       GetSQLValueString($_POST['fonction_id5'], "int"),
                       GetSQLValueString($_POST['personne_id5'], "int"),
					   GetMontantValue($typeCommission_id, GetSQLValueString($_POST['fonction_id5'], "int")),
					   GetSQLValueString("cinq", "text"),
                       GetSQLValueString(5, "int"),
					   GetSQLValueString($date, "date")); }

if (isset($_POST['personne_id6']) && isset($_POST['fonction_id6']))	{			   
 $insertSQL6 = sprintf("INSERT INTO membres (commissions_commission_id, fonctions_fonction_id, personnes_personne_id, montant, checboxName, position, dateCreation) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['commission_id'], "int"),
                       GetSQLValueString($_POST['fonction_id6'], "int"),
                       GetSQLValueString($_POST['personne_id6'], "int"),
					   GetMontantValue($typeCommission_id, GetSQLValueString($_POST['fonction_id6'], "int")),
					   GetSQLValueString("six", "text"),
                       GetSQLValueString(6, "int"),
					   GetSQLValueString($date, "date")); }

if (isset($_POST['personne_id7']) && isset($_POST['fonction_id7']))	{			   
 $insertSQL7 = sprintf("INSERT INTO membres (commissions_commission_id, fonctions_fonction_id, personnes_personne_id, montant, checboxName, position, dateCreation) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['commission_id'], "int"),
                       GetSQLValueString($_POST['fonction_id7'], "int"),
                       GetSQLValueString($_POST['personne_id7'], "int"),
					   GetMontantValue($typeCommission_id, GetSQLValueString($_POST['fonction_id7'], "int")),
...
?>
          ...
          <td align="center"><?php if (isset($row_rsPersonnes['add_commission'])) { ?>
              ...
              <a href="change_etat_index.php?comID=<?php echo $_GET['comID']; ?>&recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&map=personnes&amp;mapid=personne_id&amp;action=add_com&menuID=<?php echo $_GET['menuID']; ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
              <?php } else {?>
              <a href="change_etat_index.php?recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=add_com&menuID=<?php echo $_GET['menuID']; ?>"><img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
              <?php } ?>
            <?php }  ?>
            &nbsp;
          </td>
...
?>
            ...
            <td nowrap>
              <?php if (isset ($_GET['comID'])) { ?> 
              <a href="change_etat_index.php?comID=<?php echo $_GET['comID'];?>&recordID=<?php echo $row_rsPersonnesAdd['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=move_com&menuID=<?php echo $_GET['menuID']; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>
              <?php } else { ?>
              <a href="change_etat_index.php?recordID=<?php echo $row_rsPersonnesAdd['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=move_com&menuID=<?php echo $_GET['menuID']; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>   
          <?php } ?>
          </tr>
          <?php } // Show if recordset not empty ?>
