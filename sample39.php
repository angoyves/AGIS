...
<table width="60%" border="1" align="center" class="std">
  ...
  <?php $counter=0; do  { $counter++; ?>
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      <td nowrap="nowrap"><a href="#"> <img src="img/b_views.png" width="16" height="16" /></a></td>
      ...
      <td nowrap="nowrap"><select name="select" id="select">
      </select></td>
      <td nowrap="nowrap"><input type="text" name="textfield" id="textfield" /></td>
      <td align="center" nowrap="nowrap"><?php if (isset($row_rsPersonnes['add_commission'])) { ?>
          <?php if (isset ($_GET['comID'])) { ?>
          <a href="sample40.php?comID=<?php echo $_GET['comID']; ?>&pID=<?php echo $row_rsPersonnes['personne_id']; ?>&uID=<?php echo $_GET['uID'] ?>&map=personnes&amp;mapid=personne_id&amp;action=add_com&page=addMbr3&fID=<?php echo $_GET['comID']; ?>&aID=<?php echo $_GET['aID']; ?>&mID=<?php echo $_GET['mID']; ?>"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
          <?php } else {?>
          <a href="sample40.php?recordID=<?php echo $row_rsPersonnes['personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=add_com&page=addMbr3&fID=<?php echo $_GET['comID']; ?>&pID=<?php echo $_GET['pID=']; ?>&aID=<?php echo $_GET['aID']; ?>&mID=<?php echo $_GET['mID']; ?>"><img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle"/></a>
          <?php } ?>
        <?php }  ?>
  &nbsp;
    </td>
...
<?php } else {// Show if recordset not empty ?>
  <tr>
    <td colspan="7"><table width="100%" border="1" align="left">
      <tr>
      ...
      <tr>
        ...
        <?php           
	 	  ...
	 	  ?>
          <a href="#" onclick="<?php popup($showGoTo, "610", "300"); ?>">Enregistrer  une personne au fichier...<img src="img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle" /></a>
          </td>
      </tr>
    </table></td>
  </tr>
