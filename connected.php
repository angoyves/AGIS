    ...
    <div class="signon-main"> <img src="images/img/logo_minmap.gif" alt="Connexion à AGIS" width="250" height="223" class="ps-staticimg" title="Connexion à AGIS" />
      <div class="ps_signinentry expire">
        <div id="ps-img">
          ...
          <p class="ps_loginmessagelarge"><a href="myconnexions.php?uID=<?php echo $_GET['uID'] ?>" class="ps-button" >Cliquez ici si vous etes le propriétaire de ce compte AGIS.</a></p>
        </div>
      </div>
