...
$query_DetailRS1 = sprintf("SELECT commission_id, commission_lib, personne_id, personne_nom, personne_prenom, fonction_lib, jour, mois, annee FROM sessions, commissions, personnes, fonctions WHERE sessions.membres_commissions_commission_id = commissions.commission_id AND sessions.membres_personnes_personne_id = personnes.personne_id AND sessions.membres_fonctions_fonction_id = fonctions.fonction_id AND sessions.membres_commissions_commission_id = %s", GetSQLValueString($colname_DetailRS1, "int"));
...
<table border="1" align="center" class="std">
  <tr>
    <th colspan="9" nowrap="nowrap"><?php echo $row_DetailRS1['commission_lib']; ?></th>
  </tr>
  <tr>
    <td colspan="9">MOIS DE <?php echo $row_DetailRS1['mois']; ?>/<?php echo $row_DetailRS1['annee']; ?></td>
  </tr>
  <tr>
    <td colspan="9">&nbsp;</td>
  </tr>
  ...
  <?php do { ?>
    <tr>
      <td nowrap="nowrap"><?php echo $row_DetailRS1['personne_id']; ?>&nbsp; </td>
      <td nowrap="nowrap"><?php echo $row_DetailRS1['personne_nom']; ?>&nbsp; </td>
      <td nowrap="nowrap"><?php echo $row_DetailRS1['personne_prenom']; ?>&nbsp; </td>
      <td nowrap="nowrap"><?php echo $row_DetailRS1['fonction_lib']; ?>&nbsp; </td>
      <td nowrap="nowrap"><?php echo $row_DetailRS1['jour']; ?>&nbsp; </td>
      <td nowrap="nowrap">&nbsp; </td>
      <td nowrap="nowrap">&nbsp; </td>
      <td nowrap="nowrap">&nbsp; </td>
      <td nowrap="nowrap">&nbsp; </td>
...
<br />
 Records <?php echo ($startRow_DetailRS1 + 1) ?> to <?php echo min($startRow_DetailRS1 + $maxRows_DetailRS1, $totalRows_DetailRS1) ?> of <?php echo $totalRows_DetailRS1 ?>
<!-- InstanceEndEditable -->
    <!--div class="bloc express">
				<h4>Informations express</h4>
				<p><span>9 mars 2009</span><br>
