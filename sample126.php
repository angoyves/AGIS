    ...
    <tr valign="baseline">
      <td align="left" nowrap="nowrap"><table border="0" class="std2">
        <tr>
          ...
          <td>&nbsp;</td>
          <th>Annee:</th>
          <td><select name="mois2" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
            <option value="" >[ Choisir ]</option>
            <?php combo_redirect("mois", "mois_id", "lib_mois", "mois_id", $link, $_GET['mID']) ?>
          </select>&nbsp;</td>
          <td>&nbsp;</td>
    ...
    <tr valign="baseline">
      <td align="left" nowrap="nowrap"><input type="hidden" name="jour" value="<?php show_content($err_msg, $_POST['jour']) ?>" size="32" />        
        ...
        <table border="1" class="std">
          ...
          <?php //} while($counter < $row_rsJourMois['nbre_jour']); ?>
          <td><a href="activ_rep.php?comID=<?php echo $_GET['comID']; ?>&amp;perID=<?php echo $row_rsRepresentant['personne_id'];?>&amp;mID=<?php echo $_GET['mID']; ?>&amp;action=desactive&amp;menuID=<?php echo $_GET['menuID']; ?>&page=sample23"><img src="images/img/s_cancel.png" alt="" width="16" height="16" align="absmiddle"/></a></td>
            </tr>
