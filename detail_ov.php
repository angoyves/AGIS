...
if (isset($_GET['ovID'])) {
  $colname_rsAppurements = $_GET['ovID'];
}
...
<?php
echo '<a href="view_appurements.php?ovID=' . trim($_REQUEST['ovID']) . '&comID=' . $comID . '&m1ID=' . $m1ID . '&m2ID=' . $m2ID . '&aID=' . $aID . '">Retour à l\'ecran precedent</a>'; ?>
