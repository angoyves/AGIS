...
<table>
  <tr>
    ...
    <?php $link6 = "new_representant.php?aID=" . $_POST['txt_Year']. "&mID=" . $_POST['txt_Month'] . "&comID=" . $_GET['comID'] . "&menuID=6" ?>
      <a href="sample59.php?menuID=<?php echo $_GET['menuID'];?>&amp;action=<?php echo $_GET['action'];?>&amp;comID=<?php echo $row_rsCommissions['commission_id']; ?>"><img src="images/img/b_print.png" width="16" height="16" />&nbsp;Imprimer recepitulatif</a>&nbsp;
      </td>
    <td>&nbsp;</td>
  </tr>
</table></BR>
...
<?php //if (isset($_GET['action']) && $_GET['action'] == 'show') {?>
    ...
    <th width="117" colspan="2" nowrap="nowrap">&nbsp;</th>
<?php //} ?>
  </tr>
<?php } ?>
</form>
  <tr>
    ...
    <?php } ?>
<?php //if (isset($_GET['action']) && $_GET['action'] == 'upd') {?>
    <th colspan="4" nowrap="nowrap">Operations</th>
<?php //} ?>
<?php //if (isset($_GET['action']) && $_GET['action'] == 'show') {?>
    <?php //} ?>
  </tr>
...
<?php $user_group = MinmapDB::getInstance()->get_user_groupe_by_name($_SESSION['MM_Username']);
	if (isset($user_group) && $user_group == '0'){ ?>
      ...
      <td nowrap="nowrap">
      <?php if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==4 || $_SESSION['MM_UserGroup']==5 || $_SESSION['MM_UserGroup']==6)){ ?>
      <a href="sample58.php?menuID=<?php echo $_GET['menuID'];?>&amp;action=<?php echo $_GET['action'];?>&amp;comID=<?php echo $row_rsCommissions['commission_id']; ?>&lID=<?php echo $row_rsCommissions['localite_id']; ?>"><img src="images/img/b_views.png" width="16" height="16" />Details sessions</a>
...
<?php $user_group = MinmapDB::getInstance()->get_user_groupe_by_name($_SESSION['MM_Username']);
	if (isset($_SESSION['MM_UserGroup']) && ($_SESSION['MM_UserGroup']==1 || $_SESSION['MM_UserGroup']==5 || $_SESSION['MM_UserGroup']==6)){ ?>
      ...
      <a href="#" onclick="<?php 
	  $link11 = "sample59.php?aID=" . $_POST['txt_Year']. "&mID=" . $_POST['txt_Month'] . "&comID=" . $row_rsCommissions['commission_id']. "&menuID=" . $_GET['menuID'];
