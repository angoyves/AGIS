...
AND (sessions.membres_fonctions_fonction_id BETWEEN 1 AND 5 OR sessions.membres_fonctions_fonction_id = 40)
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="75%" border="0" align="center">
    ...
    <tr>
      <td><h1>Representant maitre d'ouvrage</h1>&nbsp;</td>
    </tr>
    <tr>
      <td><table border="0">
        <tr>
	...
	?>
      ...
      <table border="1" class="std">
          ...
          <?php echo ((in_array($value, $liste))? "checked='checked'":"") ?> /></td>
            ...
            <?php //} while($counter < $row_rsJourMois['nbre_jour']); ?>
<td><a href="activ_rep2.php?comID=<?php echo $_GET['comID']; ?>&amp;perID=<?php echo $row_rsRepresentant['personne_id'];?>&amp;mID=<?php echo $_GET['mID']; ?>&amp;action=desactive&amp;menuID=<?php echo $_GET['menuID']; ?>&page=sample26"><img src="images/img/s_cancel.png" alt="" width="16" height="16" align="absmiddle"/></a></td>
</tr>
