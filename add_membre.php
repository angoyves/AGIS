...
{*/
 $insertSQL = sprintf("INSERT INTO membres (commissions_commission_id, fonctions_fonction_id, personnes_personne_id, montant, checboxName, position, user_id) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
?>
  ...
  <?php }
    ...
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      ...
      <td align="right"><?php echo strtoupper(number_format($row_rsMembres['montant'],0,' ',' ')); ?>&nbsp;</td>
      <td align="center">
	  <?php $user_group = MinmapDB::getInstance()->get_user_groupe_by_name($_SESSION['MM_Username']);
		if (isset($user_group) && $user_group == '0'){ ?>
		<?php if (isset ($_GET['comID'])) { ?> 
        <a href="test6.php?comID=<?php echo $_GET['comID'];?>&recordID=<?php echo $row_rsMembres['personnes_personne_id']; ?>&amp;map=personnes&amp;mapid=personne_id&amp;action=move_com&page=addMbr&fID=<?php echo $_GET['comID']; ?>&pID=<?php echo $_GET['pID=']; ?>&aID=<?php echo $_GET['aID']; ?>&mID=<?php echo $_GET['mID']; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>
        <?php } else { ?>
        <a href="test6.php?recordID=<?php echo $row_rsPersonnesAdd['personne_id']; ?>&amp;&amp;map=personnes&amp;&amp;mapid=personne_id&amp;&amp;action=move_com&page=addMbr&fID=<?php echo $_GET['comID']; ?>&pID=<?php echo $_GET['pID=']; ?>&aID=<?php echo $_GET['aID']; ?>&mID=<?php echo $_GET['mID']; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle" /></a>   
        <?php } }?>&nbsp;</td>
      </tr>
    ...
    <tr>
      <td colspan="10">
        <?php           
	 	  ...
	 	  ?>
        <a href="#" onclick="<?php popup($showGoTo, "710", "450"); ?>">Ajouter  un nouveau membre &agrave; la commission...<img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle" /></a>&nbsp;</td>
      </tr>
    <tr>
      <th colspan="5">N°</th>
      <th>RIB</th>
