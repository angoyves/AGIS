  ...
  <table width="60%" border="1" align="center" class="std">
    ...
    <tr>
	  ...
	  $deleteGoTo = "delete_sca.php?comscaID=".$row_rsSousCommission['commission_id']."&mID=".$txt_Month."&aID=".$txt_Year;
		  ...
		  echo $deleteGoTo; ?>"><img src="images/img/b_drop.png" alt="" width="16" height="16" align="absmiddle"/><?php //echo $row_rsSousCommission['commission_id']; ?><?php //echo $count; ?></a><br /></td>
      <?php 
