...
if (!isset($_SESSION)) {
  session_start();
	...
	$txtComID = (isset($_REQUEST['comID'])?$_REQUEST['comID']:527);
	...
	//$txtValid = MinmapDB::getInstance()->etat_valid($txtComID, $txtMonth1, $txtYear);
...
mysql_select_db($database_MyFileConnect, $MyFileConnect);
$query_rsSessions_sCom = sprintf("SELECT commission_id, personnes.personne_id, personne_nom, personne_prenom, nombre_jour, annee, montant, sum(nombre_jour * montant) as total
...
<table width="60%" border="0" align="center">
  ...
  <tr>
    <td align="center">&nbsp;</td>
    <td align="center"><strong class="welcome"><?php echo htmlentities(strtoupper($row_rsSessions['commission_lib'])); ?></strong></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td align="center">BILAN du mois de <strong><?php echo strtoupper(MinmapDB::getInstance()->get_mois_lib($txtMonth1)); ?></strong> à <strong><?php echo strtoupper(MinmapDB::getInstance()->get_mois_lib($txtMonth2)); ?> <?php echo  $txtYear; ?></strong></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<tr>
      ...
      <tr>
		...
		$montantRetenu = $montanSessions*$_SESSION['MM_Retenu'];
		$netAPercevoir = $montanSessions - $montantRetenu; 
    ...
    <tr>
      ...
      <td align="right" nowrap="nowrap"><?php /*echo $txtComID ."-" . $row_rsSessions_sCom['personne_id'] ."-" . $row_rsSessions_sCom['fonction_id'] ."-" . $count ."-" .$txtYear;/*
			...
			<?php 
				...
				$nombre_jours = MinmapDB::getInstance()->get_nombre_jour_sCom_by_values($txtComID, $row_rsSessions_sCom['personne_id'], $count, $txtYear);
				if (isset($nombre_jours))
				{ 
					echo $nombre_jours;
					$sommer = $sommer + $nombre_jours;
      ...
      <?php
		...
		$montantRetenuSco = $montanSessionsSco*$_SESSION['MM_Retenu'];
		$netAPercevoirSco = $montanSessionsSco - $montantRetenuSco; 
	  ...
	  ?>
      <td align="right" nowrap="nowrap"><?php echo $sommer; ?>&nbsp;</td>
  ...
  <h1>Représentant Maitre d'Ouvrage</h1>
        <table border="1" align="center" class="print">
          ...
          <tr>
			...
			$montantRetenuRep = $montanSessionsRep*$_SESSION['MM_Retenu'];
			$netAPercevoirRep = $montanSessionsRep - $montantRetenuRep; 
  ...
  ?>
    <td colspan="3"><table border="0" align="center" class="print">
      <tr>
        ...
        <td align="right"><strong><?php echo number_format($somNetPercevoirRep,0,' ',' '); ?>&nbsp;</strong></td>
      </tr>
      <tr>
        <td>Total de la Sous Commission</td>
        <td align="right"><strong><?php echo number_format($somNetPercevoirSco,0,' ',' '); ?>&nbsp;</strong></td>
      </tr>
	  <tr>
        <td>Total de la Commission</td>
        <td align="right"><strong><?php echo number_format($somNetPercevoir,0,' ',' ') //echo number_format($montant2,0,' ',' '); ?>&nbsp;</strong></td>
      </tr>
	  <tr>
