...
<p><a href="#" onClick="<?php popup('etat_operations.php', "1200", "700"); ?>">Imprimer</a></p>
<table border="1" align="center" class="std">
  ...
  <?php $counter=0; do  { $counter++; ?>
    <tr bgcolor="<?php echo alter_color($counter, "#eee", "#FFF"); ?>">
      ...
      <td>
        <textarea cols="50" rows="2" readonly="readonly"><?php echo $row_RsHistorique['ModificationType']; ?></textarea>        &nbsp;</td>
