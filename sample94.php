...
<body>
<form action="sample96.php" method="POST">
  <p>&nbsp;</p>
...
?>
      </select>      <input type="hidden" name="comID" id="comID" value="<?php echo $_GET['comID'] ?>"/>
      <input type="hidden" name="pID" id="pID" value="<?php echo $_GET['pID'] ?>"/></td>
