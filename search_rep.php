  ...
  <tr>
    <td colspan="4"><table width="100%" border="1" align="left">
      ...
      <?php if(isset($_POST['button']) && (isset($_GET['modID']) && $_GET['modID']==1)) {?>
        <td colspan="4"><a href="membre_ins.php?txtSearch=<?php echo $_POST['txt_search']?>&lID=<?php echo $_GET['lID'] ?>&menuID=2&amp;action=new&amp;page=new_representant&amp;comID=<?php echo $_GET['comID']; ?>&modID=<?php echo $_GET['modID']; ?>&menuID=<?php echo $_GET['menuID']; ?>"></BR>Ajouter une nouvelle personne<img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle" /></a></td>
      <?php } else { ?>
      <td colspan="4"><a href="sample14.php?txtSearch=<?php echo $_POST['txt_search']?>&lID=<?php echo $_GET['lID'] ?>&menuID=2&amp;action=new&amp;page=new_representant&amp;comID=<?php echo $_GET['comID']; ?>&modID=<?php echo $_GET['modID']; ?>&menuID=<?php echo $_GET['menuID']; ?>"></BR>Ajouter une nouvelle personne<img src="images/img/b_snewtbl.png" alt="" width="16" height="16" align="absmiddle" /></a></td>
      <?php } ?>
      </tr>
    </table></td>
  </tr>
