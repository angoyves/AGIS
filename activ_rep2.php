...
$editFormAction = $_SERVER['PHP_SELF'];
	...
	if ((isset($_GET['action'])) && ($_GET['action'] == "desactive")) {
		...
		$updateSQL = sprintf("UPDATE membres SET display=%s, dateUpdate=%s WHERE commissions_commission_id=%s AND fonctions_fonction_id=%s AND personnes_personne_id=%s",
							   GetSQLValueString($_GET['display'], "text"),
